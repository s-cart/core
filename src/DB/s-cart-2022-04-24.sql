...
INSERT INTO `oauth_clients` (`id`, `user_id`, `name`, `secret`, `provider`, `redirect`, `personal_access_client`, `password_client`, `revoked`, `created_at`, `updated_at`) VALUES
	('9623e013-6589-4eb2-8d1f-5fa88f285349', NULL, 'SCart Personal Access Client', 'zp7A023SyGOXwM7g5i1U5jnWPM0kiCkKiSt63Sfe', NULL, 'http://localhost', 1, 0, 0, '2022-04-24 20:51:13', '2022-04-24 20:51:13'),
	('9623e013-6b7b-4660-aba8-c60418ac88ae', NULL, 'SCart Password Grant Client', 'bfiH2o2yNypUE0QJjZP9lXumDE85rg7nJlmAv2JB', 'users', 'http://localhost', 0, 1, 0, '2022-04-24 20:51:13', '2022-04-24 20:51:13');
...
INSERT INTO `oauth_personal_access_clients` (`id`, `client_id`, `created_at`, `updated_at`) VALUES
	(1, '9623e013-6589-4eb2-8d1f-5fa88f285349', '2022-04-24 20:51:13', '2022-04-24 20:51:13');
...
INSERT INTO `sc_admin_user` (`id`, `username`, `password`, `name`, `email`, `avatar`, `remember_token`, `theme`, `created_at`, `updated_at`) VALUES
	('1', 'admin', '$2y$10$5MvPkBi3oA6PJuWyYWvxq.Qe4jXwunUupYeWMokyJRDEqMtmxt.3q', 'Administrator', 'demo@s-cart.org', '/admin/avatar/user.jpg', NULL, NULL, NULL, NULL);
...
INSERT INTO `sc_api_connection` (`id`, `description`, `apiconnection`, `apikey`, `expire`, `last_active`, `created_at`, `updated_at`, `status`) VALUES
	(1, 'Demo api connection', 'appmobile', '9623e012-371f-4a80-9ea8-91c5938af3ac', NULL, NULL, NULL, NULL, 0);
...
-- Dumping data for table s-cart.sc_languages: ~2,656 rows (approximately)
...
INSERT INTO `sc_languages` (`id`, `code`, `text`, `position`, `location`, `created_at`, `updated_at`) VALUES
	...
	(2280, 'admin.role.name', 'Tên', 'admin.role', 'vi', NULL, NULL),
	(2281, 'admin.role.roles', 'vai trò', 'admin.role', 'vi', NULL, NULL),
	(2282, 'admin.role.permission', 'Quyền hạn', 'admin.role', 'vi', NULL, NULL),
	...
	(2285, 'admin.role.created_at', 'Tạo lúc', 'admin.role', 'vi', NULL, NULL),
	(2286, 'admin.role.updated_at', 'Cập nhật', 'admin.role', 'vi', NULL, NULL),
	(2287, 'admin.role.slug_validate', 'Chỉ sử dụng kí tự trong nhóm: "A-Z", "a-z", "0-9" and "._-" ', 'admin.role', 'vi', NULL, NULL),
	(2288, 'admin.role.add_new', 'Thêm mới', 'admin.role', 'vi', NULL, NULL),
	(2289, 'admin.role.add_new_title', 'Tạo quyền', 'admin.role', 'vi', NULL, NULL),
	(2290, 'admin.role.add_new_des', 'Tạo mới một quyền', 'admin.role', 'vi', NULL, NULL),
	(2291, 'admin.role.select_permission', 'Chọn quyền hạn', 'admin.role', 'vi', NULL, NULL),
	(2292, 'admin.role.select_user', 'Chọn người dùng', 'admin.role', 'vi', NULL, NULL),
	...
	(2338, 'admin.template.import', 'Import Giao diện', 'admin.template', 'vi', NULL, NULL),
	(2339, 'admin.template.file_format', 'File mẫu', 'admin.template', 'vi', NULL, NULL),
	(2340, 'admin.template.choose_file', 'Chọn file', 'admin.template', 'vi', NULL, NULL),
	(2341, 'admin.template.import_submit', 'Import', 'admin.template', 'vi', NULL, NULL),
	(2342, 'admin.template.import_note', 'Là file <span style="color:red">.zip</span>, dung lượng tối đa <span style="color:red">50MB</span>', 'admin.template', 'vi', NULL, NULL),
	(2343, 'admin.template.error_unzip', 'Lỗi trong khi unzip', 'admin.template', 'vi', NULL, NULL),
	(2344, 'admin.template.error_upload', 'Lỗi trong khi upload file', 'admin.template', 'vi', NULL, NULL),
	(2345, 'admin.template.error_check_config', 'Không tìm thấy hoặc không thể đọc file config', 'admin.template', 'vi', NULL, NULL),
	(2346, 'admin.template.error_config_format', 'File config không đúng định dạng', 'admin.template', 'vi', NULL, NULL),
	(2347, 'admin.template.import_success', 'Import thành công!', 'admin.template', 'vi', NULL, NULL),
	(2348, 'admin.template.error_exist', 'Giao diện đã tồn tại!', 'admin.template', 'vi', NULL, NULL),
	...
	(2350, 'admin.template.template_more', '<a href="https://s-cart.org/vi/template.html" target=_new><i class="fa fa-download" aria-hidden="true"></i> Download đầy đủ Ở ĐÂY</a>', 'admin.template', 'vi', NULL, NULL),
	(2351, 'admin.template.manager', 'Quản lý giao diện', 'admin.template', 'vi', NULL, NULL),
	(2352, 'admin.template.title', 'Danh sách giao diện', 'admin.template', 'vi', NULL, NULL),
	(2353, 'admin.template.name', 'Tên giao diện', 'admin.template', 'vi', NULL, NULL),
	(2354, 'admin.template.email', 'Email', 'admin.template', 'vi', NULL, NULL),
	(2355, 'admin.template.website', 'Website', 'admin.template', 'vi', NULL, NULL),
	(2356, 'admin.template.activated', 'Đang hoạt động', 'admin.template', 'vi', NULL, NULL),
	(2357, 'admin.template.inactive', 'Đang ẩn', 'admin.template', 'vi', NULL, NULL),
	(2358, 'admin.template.download', 'Tải về', 'admin.template', 'vi', NULL, NULL),
	(2359, 'admin.template.remove', 'Gỡ bỏ', 'admin.template', 'vi', NULL, NULL),
	(2360, 'admin.template.status', 'Trạng thái', 'admin.template', 'vi', NULL, NULL),
	(2361, 'admin.template.action', 'Hành động', 'admin.template', 'vi', NULL, NULL),
	(2362, 'admin.template.installing', 'Đang cài đặt', 'admin.template', 'vi', NULL, NULL),
	(2363, 'admin.template.local', 'Đã lưu trên máy', 'admin.template', 'vi', NULL, NULL),
	(2364, 'admin.template.online', 'Tải từ thư viện', 'admin.template', 'vi', NULL, NULL),
	(2365, 'admin.template.auth', 'Tác giả', 'admin.template', 'vi', NULL, NULL),
	(2366, 'admin.template.version', 'Phiên bản', 'admin.template', 'vi', NULL, NULL),
	(2367, 'admin.template.link', 'Liên kết', 'admin.template', 'vi', NULL, NULL),
	(2368, 'admin.template.image', 'Hình ảnh', 'admin.template', 'vi', NULL, NULL),
	(2369, 'admin.template.empty', 'Chưa có template nào!', 'admin.template', 'vi', NULL, NULL),
	(2370, 'admin.template.downloaded', 'Số lần tải', 'admin.template', 'vi', NULL, NULL),
	(2371, 'admin.template.rated', 'Đánh giá', 'admin.template', 'vi', NULL, NULL),
	(2372, 'admin.template.price', 'Giá', 'admin.template', 'vi', NULL, NULL),
	(2373, 'admin.template.free', 'Miễn phí', 'admin.template', 'vi', NULL, NULL),
	(2374, 'admin.template.date', 'Ngày tạo', 'admin.template', 'vi', NULL, NULL),
	(2375, 'admin.template.located', 'Đã tải về', 'admin.template', 'vi', NULL, NULL),
	(2376, 'admin.template.code', 'Mã code', 'admin.template', 'vi', NULL, NULL),
	(2377, 'admin.template.click_here', 'Bấm vào đây', 'admin.template', 'vi', NULL, NULL),
	(2378, 'admin.template.image_demo', 'Hình mẫu', 'admin.template', 'vi', NULL, NULL),
	(2379, 'admin.template.only_version_current', 'Chỉ phiên bản này', 'admin.template', 'vi', NULL, NULL),
	(2380, 'admin.template.compatible', 'Tương thích', 'admin.template', 'vi', NULL, NULL),
	(2381, 'admin.template.used', 'Đang sử dụng', 'admin.template', 'vi', NULL, NULL),
	(2382, 'admin.template.list', 'Danh sách giao diện', 'admin.template', 'vi', NULL, NULL),
	(2383, 'admin.plugin.compatible', 'Tương thích', 'admin.plugin', 'vi', NULL, NULL),
	(2384, 'admin.plugin.code', 'Mã code', 'admin.plugin', 'vi', NULL, NULL),
	(2385, 'admin.plugin.name', 'Tên chức năng', 'admin.plugin', 'vi', NULL, NULL),
	(2386, 'admin.plugin.sort', 'Thứ tự', 'admin.plugin', 'vi', NULL, NULL),
	(2387, 'admin.plugin.action', 'Hành động', 'admin.plugin', 'vi', NULL, NULL),
	(2388, 'admin.plugin.status', 'Trạng thái', 'admin.plugin', 'vi', NULL, NULL),
	(2389, 'admin.plugin.enable', 'Kích hoạt', 'admin.plugin', 'vi', NULL, NULL),
	(2390, 'admin.plugin.disable', 'Tắt', 'admin.plugin', 'vi', NULL, NULL),
	(2391, 'admin.plugin.remove', 'Gỡ bỏ', 'admin.plugin', 'vi', NULL, NULL),
	(2392, 'admin.plugin.only_delete_data', 'Chỉ xóa dữ liệu', 'admin.plugin', 'vi', NULL, NULL),
	(2393, 'admin.plugin.install', 'Cài đặt', 'admin.plugin', 'vi', NULL, NULL),
	(2394, 'admin.plugin.config', 'Cấu hình', 'admin.plugin', 'vi', NULL, NULL),
	(2395, 'admin.plugin.actived', 'Hoạt động', 'admin.plugin', 'vi', NULL, NULL),
	(2396, 'admin.plugin.disabled', 'Bị tắt', 'admin.plugin', 'vi', NULL, NULL),
	(2397, 'admin.plugin.not_install', 'Chưa cài đặt', 'admin.plugin', 'vi', NULL, NULL),
	(2398, 'admin.plugin.auth', 'Tác giả', 'admin.plugin', 'vi', NULL, NULL),
	(2399, 'admin.plugin.version', 'Phiên bản', 'admin.plugin', 'vi', NULL, NULL),
	(2400, 'admin.plugin.link', 'Liên kết', 'admin.plugin', 'vi', NULL, NULL),
	(2401, 'admin.plugin.image', 'Hình ảnh', 'admin.plugin', 'vi', NULL, NULL),
	(2402, 'admin.plugin.empty', 'Chưa có extension nào!', 'admin.plugin', 'vi', NULL, NULL),
	(2403, 'admin.plugin.local', 'Đã lưu trên máy', 'admin.plugin', 'vi', NULL, NULL),
	(2404, 'admin.plugin.online', 'Tải từ thư viện', 'admin.plugin', 'vi', NULL, NULL),
	(2405, 'admin.plugin.downloaded', 'Số lần tải', 'admin.plugin', 'vi', NULL, NULL),
	(2406, 'admin.plugin.rated', 'Đánh giá', 'admin.plugin', 'vi', NULL, NULL),
	(2407, 'admin.plugin.price', 'Giá', 'admin.plugin', 'vi', NULL, NULL),
	(2408, 'admin.plugin.free', 'Miễn phí', 'admin.plugin', 'vi', NULL, NULL),
	(2409, 'admin.plugin.date', 'Ngày tạo', 'admin.plugin', 'vi', NULL, NULL),
	(2410, 'admin.plugin.located', 'Đã tải về', 'admin.plugin', 'vi', NULL, NULL),
	(2411, 'admin.plugin.only_free', 'Là miễn phí', 'admin.plugin', 'vi', NULL, NULL),
	(2412, 'admin.plugin.only_version', 'Cùng phiên bản', 'admin.plugin', 'vi', NULL, NULL),
	(2413, 'admin.plugin.all_version', 'Tất cả phiên bản', 'admin.plugin', 'vi', NULL, NULL),
	(2414, 'admin.plugin.sort_price_asc', 'Giá tăng', 'admin.plugin', 'vi', NULL, NULL),
	(2415, 'admin.plugin.sort_price_desc', 'Giá giảm', 'admin.plugin', 'vi', NULL, NULL),
	(2416, 'admin.plugin.sort_rating', 'Bình chọn', 'admin.plugin', 'vi', NULL, NULL),
	(2417, 'admin.plugin.sort_download', 'Lượt tải', 'admin.plugin', 'vi', NULL, NULL),
	(2418, 'admin.plugin.search_keyword', 'Từ khóa', 'admin.plugin', 'vi', NULL, NULL),
	(2419, 'admin.plugin.enter_search_keyword', 'Nhập từ khóa', 'admin.plugin', 'vi', NULL, NULL),
	(2420, 'admin.plugin.search_submit', 'Lọc kết quả', 'admin.plugin', 'vi', NULL, NULL),
	(2421, 'admin.plugin.import', 'Import Plugin', 'admin.plugin', 'vi', NULL, NULL),
	(2422, 'admin.plugin.file_format', 'File mẫu', 'admin.plugin', 'vi', NULL, NULL),
	(2423, 'admin.plugin.choose_file', 'Chọn file', 'admin.plugin', 'vi', NULL, NULL),
	...
	(2426, 'admin.plugin.import_note', 'Là file <span style="color:red">.zip</span>, dung lượng tối đa <span style="color:red">50MB</span>', 'admin.plugin', 'vi', NULL, NULL),
	(2427, 'admin.plugin.error_unzip', 'Lỗi trong khi unzip', 'admin.plugin', 'vi', NULL, NULL),
	(2428, 'admin.plugin.error_upload', 'Lỗi trong khi upload file', 'admin.plugin', 'vi', NULL, NULL),
	(2429, 'admin.plugin.error_check_config', 'Không tìm thấy hoặc không thể đọc file config', 'admin.plugin', 'vi', NULL, NULL),
	(2430, 'admin.plugin.error_config_format', 'File config không đúng định dạng', 'admin.plugin', 'vi', NULL, NULL),
	(2431, 'admin.plugin.import_success', 'Import thành công!', 'admin.plugin', 'vi', NULL, NULL),
	(2432, 'admin.plugin.error_exist', 'Plugin đã tồn tại!', 'admin.plugin', 'vi', NULL, NULL),
	...
	(2434, 'admin.plugin.plugin_more', '<a href="https://s-cart.org/vi/plugin.html" target=_new><i class="fa fa-download" aria-hidden="true"></i> Download đầy đủ Ở ĐÂY</a>', 'admin.plugin', 'vi', NULL, NULL),
	...
	(2443, 'admin.plugin.Shipping_plugin', 'Chức năng vận chuyển', 'admin.plugin', 'vi', NULL, NULL),
	(2444, 'admin.plugin.Payment_plugin', 'Chức năng thanh toán', 'admin.plugin', 'vi', NULL, NULL),
	(2445, 'admin.plugin.Total_plugin', 'Chức năng giá trị đơn hàng', 'admin.plugin', 'vi', NULL, NULL),
	(2446, 'admin.plugin.Fee_plugin', 'Chức năng phí đơn hàng', 'admin.plugin', 'vi', NULL, NULL),
	(2447, 'admin.plugin.Other_plugin', 'Chức năng khác', 'admin.plugin', 'vi', NULL, NULL),
	...
	(2508, 'admin.plugin.install_success', 'Cài đặt thành công', 'admin.plugin', 'vi', NULL, NULL),
	(2509, 'admin.plugin.install_faild', 'Cài đặt thất bại', 'admin.plugin', 'vi', NULL, NULL),
	(2510, 'admin.plugin.table_exist', 'Bảng :table đã tồn tại rồi', 'admin.plugin', 'vi', NULL, NULL),
	(2511, 'admin.plugin.plugin_exist', 'Plugin này đã tồn tại rồi', 'admin.plugin', 'vi', NULL, NULL),
	(2512, 'admin.plugin.action_error', 'Có lỗi trong khi :action', 'admin.plugin', 'vi', NULL, NULL),
	(2513, 'admin.chart.static_month', 'Thống kê trong 12 tháng', 'admin.chart', 'vi', NULL, NULL),
	(2514, 'admin.chart.static_30_day', 'Thống kê trong 1 tháng', 'admin.chart', 'vi', NULL, NULL),
	(2515, 'admin.chart.static_month_help', 'Dữ liệu so sánh bằng tổng số tiền của đơn hàng, đơn vị Bit', 'admin.chart', 'vi', NULL, NULL),
	(2516, 'admin.chart.amount', 'Tổng số tiền (Bit)', 'admin.chart', 'vi', NULL, NULL),
	(2517, 'admin.chart.order', 'Tổng đơn hàng', 'admin.chart', 'vi', NULL, NULL),
	(2518, 'admin.chart.static_country', 'Đơn hàng theo quốc gia', 'admin.chart', 'vi', NULL, NULL),
	(2519, 'admin.chart.country', 'Quốc gia', 'admin.chart', 'vi', NULL, NULL),
	...
	(2528, 'admin.chart.static_device', 'Thống kê đơn hàng theo thiết bị', 'admin.chart', 'vi', NULL, NULL),
	(2529, 'admin.chart.static_count_order', 'Statistics of count orders', 'admin.chart', 'en', NULL, NULL),
	(2530, 'admin.chart.static_count_order', 'Thống kê tổng số đơn hàng', 'admin.chart', 'vi', NULL, NULL),
	(2531, 'admin.chart.device', 'Device type', 'admin.chart', 'en', NULL, NULL),
	(2532, 'admin.chart.device', 'Loại thiết bị', 'admin.chart', 'vi', NULL, NULL),
	...
	(2537, 'admin.maintain.title', 'Trang bảo trì', 'admin.maintain', 'vi', NULL, NULL),
	(2538, 'admin.maintain.content', 'Nội dung bảo trì của cửa hàng', 'admin.maintain', 'vi', NULL, NULL),
	(2539, 'admin.maintain.description', 'Nội dung', 'admin.maintain', 'vi', NULL, NULL),
	(2540, 'admin.maintain.description_note', 'Ghi chú bảo trì', 'admin.maintain', 'vi', NULL, NULL),
	(2541, 'admin.seo.config', 'Cấu hình SEO', 'admin.seo', 'vi', NULL, NULL),
	(2542, 'admin.seo.config', 'SEO config', 'admin.seo', 'en', NULL, NULL),
	(2543, 'admin.seo.url_seo_lang', 'Thêm ngôn ngữ trên URL', 'admin.seo', 'vi', NULL, NULL),
	(2544, 'admin.seo.url_seo_lang', 'Add language on URL', 'admin.seo', 'en', NULL, NULL),
	(2545, 'admin.dashboard.total_order', 'Tổng đơn hàng', 'admin.dashboard', 'vi', NULL, NULL),
	(2546, 'admin.dashboard.total_order', 'Order total', 'admin.dashboard', 'en', NULL, NULL),
	(2547, 'admin.dashboard.total_product', 'Tổng sản phẩm', 'admin.dashboard', 'vi', NULL, NULL),
	(2548, 'admin.dashboard.total_product', 'Product total', 'admin.dashboard', 'en', NULL, NULL),
	(2549, 'admin.dashboard.total_customer', 'Tổng khách hàng', 'admin.dashboard', 'vi', NULL, NULL),
	(2550, 'admin.dashboard.total_customer', 'Customer total', 'admin.dashboard', 'en', NULL, NULL),
	(2551, 'admin.dashboard.total_blog', 'Tổng blog', 'admin.dashboard', 'vi', NULL, NULL),
	(2552, 'admin.dashboard.total_blog', 'Blog total', 'admin.dashboard', 'en', NULL, NULL),
	(2553, 'admin.dashboard.order_month', 'Đơn hàng trong tháng', 'admin.dashboard', 'vi', NULL, NULL),
	(2554, 'admin.dashboard.order_month', 'Order in month', 'admin.dashboard', 'en', NULL, NULL),
	(2555, 'admin.dashboard.order_year', 'Đơn hàng trong năm', 'admin.dashboard', 'vi', NULL, NULL),
	(2556, 'admin.dashboard.order_year', 'Order in year', 'admin.dashboard', 'en', NULL, NULL),
	(2557, 'admin.dashboard.top_order_new', 'Đơn hàng mới', 'admin.dashboard', 'vi', NULL, NULL),
	(2558, 'admin.dashboard.top_order_new', 'New orders', 'admin.dashboard', 'en', NULL, NULL),
	(2559, 'admin.dashboard.top_customer_new', 'Khách hàng mới mới', 'admin.dashboard', 'vi', NULL, NULL),
	(2560, 'admin.dashboard.top_customer_new', 'New customers', 'admin.dashboard', 'en', NULL, NULL),
	(2561, 'admin.dashboard.pie_chart', 'Hiển thị biểu đồ pie', 'admin.dashboard', 'vi', NULL, NULL),
	(2562, 'admin.dashboard.pie_chart', 'Display pie chart total', 'admin.dashboard', 'en', NULL, NULL),
	(2563, 'admin.dashboard.title', 'Trang tổng quan', 'admin.dashboard', 'vi', NULL, NULL),
	(2564, 'admin.dashboard.title', 'Dashboard page', 'admin.dashboard', 'en', NULL, NULL),
	(2565, 'admin.dashboard.config_display', 'Cấu hình trang tổng quan admin', 'admin.dashboard', 'vi', NULL, NULL),
	...
	(2586, 'admin.layout_page_position.all', 'Tất cả trang', 'admin.layout_page_position', 'vi', NULL, NULL),
	(2587, 'admin.layout_page_position.home', 'Trang chủ', 'admin.layout_page_position', 'vi', NULL, NULL),
	(2588, 'admin.layout_page_position.shop_home', 'Trang chủ Shop', 'admin.layout_page_position', 'vi', NULL, NULL),
	(2589, 'admin.layout_page_position.shop_search', 'Trang tìm kiếm', 'admin.layout_page_position', 'vi', NULL, NULL),
	(2590, 'admin.layout_page_position.vendor_home', 'Cửa hàng: trang chủ', 'admin.layout_page_position', 'vi', NULL, NULL),
	(2591, 'admin.layout_page_position.store_product_list', 'Cửa hàng: danh sách sản phẩm', 'admin.layout_page_position', 'vi', NULL, NULL),
	(2592, 'admin.layout_page_position.product_list', 'Danh sách: sản phẩm', 'admin.layout_page_position', 'vi', NULL, NULL),
	(2593, 'admin.layout_page_position.product_detail', 'Chi tiết: sản phẩm', 'admin.layout_page_position', 'vi', NULL, NULL),
	(2594, 'admin.layout_page_position.shop_cart', 'Giỏ hàng: giỏ hàng, wishlist, compare, checkout', 'admin.layout_page_position', 'vi', NULL, NULL),
	(2595, 'admin.layout_page_position.shop_auth', 'Chứng thực: đăng nhập, đăng ký, quên mật khẩu', 'admin.layout_page_position', 'vi', NULL, NULL),
	(2596, 'admin.layout_page_position.shop_profile', 'Tài khoản khách hàng', 'admin.layout_page_position', 'vi', NULL, NULL),
	(2597, 'admin.layout_page_position.item_list', 'Danh sách item: danh mục, nhãn hiệu, nhà cung cấp', 'admin.layout_page_position', 'vi', NULL, NULL),
	(2598, 'admin.layout_page_position.item_detail', 'Chi tiết: item', 'admin.layout_page_position', 'vi', NULL, NULL),
	(2599, 'admin.layout_page_position.news_list', 'Danh sách: bài viết Blog', 'admin.layout_page_position', 'vi', NULL, NULL),
	(2600, 'admin.layout_page_position.news_detail', 'Chi tiết: bài viết Blog', 'admin.layout_page_position', 'vi', NULL, NULL),
	(2601, 'admin.layout_page_position.content_list', 'Danh sách: bài viết CMS', 'admin.layout_page_position', 'vi', NULL, NULL),
	(2602, 'admin.layout_page_position.content_detail', 'Chi tiết: bài viết CMS', 'admin.layout_page_position', 'vi', NULL, NULL),
	(2603, 'admin.layout_page_position.shop_contact', 'Trang liên hệ', 'admin.layout_page_position', 'vi', NULL, NULL),
	(2604, 'admin.layout_page_position.shop_page', 'Các trang viết: giới thiệu...', 'admin.layout_page_position', 'vi', NULL, NULL),
	...
	(2608, 'admin.layout_page_block.left', 'BlockLeft - Cột trái', 'admin.layout_page_block', 'vi', NULL, NULL),
	(2609, 'admin.layout_page_block.right', 'Block Right - Cột phải', 'admin.layout_page_block', 'vi', NULL, NULL),
	...
	(2622, 'admin.admin_custom_config.facebook_url', 'Facebook Url', 'admin.admin_custom_config', 'vi', NULL, NULL),
	(2623, 'admin.admin_custom_config.fanpage_url', 'Fanpage Url', 'admin.admin_custom_config', 'vi', NULL, NULL),
	(2624, 'admin.admin_custom_config.twitter_url', 'Twitter Url', 'admin.admin_custom_config', 'vi', NULL, NULL),
	(2625, 'admin.admin_custom_config.instagram_url', 'Instagram Url', 'admin.admin_custom_config', 'vi', NULL, NULL),
	(2626, 'admin.admin_custom_config.youtube_url', 'Youtube Url', 'admin.admin_custom_config', 'vi', NULL, NULL),
	(2627, 'admin.admin_custom_config.add_new', 'Thêm mới cấu hình', 'admin.admin_custom_config', 'vi', NULL, NULL),
	(2628, 'admin.admin_custom_config.add_new', 'Add new config', 'admin.admin_custom_config', 'en', NULL, NULL),
	(2629, 'admin.admin_custom_config.add_new_detail', 'Thông tin cấu hình', 'admin.admin_custom_config', 'vi', NULL, NULL),
	(2630, 'admin.admin_custom_config.add_new_detail', 'Config detail', 'admin.admin_custom_config', 'en', NULL, NULL),
	(2631, 'admin.admin_custom_config.add_new_key', 'Key cấu hình', 'admin.admin_custom_config', 'vi', NULL, NULL),
	(2632, 'admin.admin_custom_config.add_new_key', 'Key config', 'admin.admin_custom_config', 'en', NULL, NULL),
	(2633, 'admin.admin_custom_config.add_new_value', 'Giá trị', 'admin.admin_custom_config', 'vi', NULL, NULL),
	(2634, 'admin.admin_custom_config.add_new_value', 'Value', 'admin.admin_custom_config', 'en', NULL, NULL),
	(2635, 'admin.admin_custom_config.key_exist', 'Key đã tồn tại', 'admin.admin_custom_config', 'vi', NULL, NULL),
	(2636, 'admin.admin_custom_config.key_exist', 'Key already exist', 'admin.admin_custom_config', 'en', NULL, NULL),
	(2637, 'admin.config_layout.link_home_page', 'Hiển thị link trang chủ', 'admin.config_layout', 'vi', NULL, NULL),
	(2638, 'admin.config_layout.link_home_page', 'Display link homepage', 'admin.config_layout', 'en', NULL, NULL),
	(2639, 'admin.config_layout.link_shop_page', 'Hiển thị link cửa hàng', 'admin.config_layout', 'vi', NULL, NULL),
	(2640, 'admin.config_layout.link_shop_page', 'Display link shop', 'admin.config_layout', 'en', NULL, NULL),
	(2641, 'admin.config_layout.link_account', 'Hiển thị link tài khoản', 'admin.config_layout', 'vi', NULL, NULL),
	(2642, 'admin.config_layout.link_account', 'Display link account', 'admin.config_layout', 'en', NULL, NULL),
	(2643, 'admin.config_layout.link_cart', 'Hiển thị giỏ hàng', 'admin.config_layout', 'vi', NULL, NULL),
	(2644, 'admin.config_layout.link_cart', 'Display link cart', 'admin.config_layout', 'en', NULL, NULL),
	(2645, 'admin.config_layout.link_language', 'Hiển thị ngôn ngữ', 'admin.config_layout', 'vi', NULL, NULL),
	(2646, 'admin.config_layout.link_language', 'Display link language', 'admin.config_layout', 'en', NULL, NULL),
	(2647, 'admin.config_layout.link_currency', 'Hiển thị tiền tệ', 'admin.config_layout', 'vi', NULL, NULL),
	(2648, 'admin.config_layout.link_currency', 'Display link currency', 'admin.config_layout', 'en', NULL, NULL),
	(2649, 'common.created_at', 'Tạo lúc', 'common', 'vi', NULL, NULL),
	(2650, 'common.created_at', 'Created at', 'common', 'en', NULL, NULL),
	(2651, 'common.updated_at', 'Cập nhật lúc', 'common', 'vi', NULL, NULL),
	(2652, 'common.updated_at', 'Updated at', 'common', 'en', NULL, NULL),
	(2653, 'common.from', 'Từ', 'common', 'vi', NULL, NULL),
	(2654, 'common.from', 'From', 'common', 'en', NULL, NULL),
	(2655, 'common.to', 'Đến', 'common', 'vi', NULL, NULL),
...
INSERT INTO `sc_shop_banner` (`id`, `title`, `image`, `url`, `target`, `html`, `status`, `sort`, `click`, `type`, `created_at`, `updated_at`) VALUES
	('9623e013-4a3a-4700-8a40-3cae80efe37d', 'Banner home 1', '/data/banner/banner-home-1.jpg', NULL, '_self', '<h1 class="swiper-title-1" data-caption-animate="fadeScale" data-caption-delay="100">Top-notch Furniture</h1><p class="biggest text-white-70" data-caption-animate="fadeScale" data-caption-delay="200">Sofa Store provides the best furniture and accessories for homes and offices.</p><div class="button-wrap" data-caption-animate="fadeInUp" data-caption-delay="300"> <span class="button button-zachem-tak-delat button-white button-zakaria"> Shop now</span> </div>', 1, 0, 0, 'banner', NULL, NULL),
	('9623e013-4a41-45d2-ad43-445b8d7fefe2', 'Banner home 2', '/data/banner/banner-home-2.jpg', NULL, '_self', '<h1 class="swiper-title-1" data-caption-animate="fadeScale" data-caption-delay="100">Top-notch Furniture</h1><p class="biggest text-white-70" data-caption-animate="fadeScale" data-caption-delay="200">Sofa Store provides the best furniture and accessories for homes and offices.</p><div class="button-wrap" data-caption-animate="fadeInUp" data-caption-delay="300"> <span class="button button-zachem-tak-delat button-white button-zakaria"> Shop now</span> </div>', 1, 0, 0, 'banner', NULL, NULL),
	('9623e013-4a46-4ca1-bd7b-677a48526d9e', 'Banner breadcrumb', '/data/banner/breadcrumb.jpg', NULL, '_self', '', 1, 0, 0, 'breadcrumb', NULL, NULL),
	('9623e013-4a4b-4ae2-9cf5-8011cee8a5c6', 'Banner store', '/data/banner/banner-store.jpg', NULL, '_self', '', 1, 0, 0, 'banner-store', NULL, NULL);
...
INSERT INTO `sc_shop_banner_store` (`banner_id`, `store_id`) VALUES
	('9623e013-4a3a-4700-8a40-3cae80efe37d', '1'),
	('9623e013-4a41-45d2-ad43-445b8d7fefe2', '1'),
	('9623e013-4a46-4ca1-bd7b-677a48526d9e', '1'),
	('9623e013-4a4b-4ae2-9cf5-8011cee8a5c6', '1');
...
INSERT INTO `sc_shop_brand` (`id`, `name`, `alias`, `image`, `url`, `status`, `sort`, `created_at`, `updated_at`) VALUES
	('9623e013-47b0-4d6c-804b-f785078e6f3d', 'DaNang', 'danang', '/data/brand/brand.jpg', NULL, 1, 0, NULL, NULL),
	('9623e013-47b8-414b-ba9c-e9069e0410c4', 'SaiGon', 'saigon', '/data/brand/brand.jpg', NULL, 1, 0, NULL, NULL),
	('9623e013-47bd-4330-a977-2ba6b2e3bb30', 'HaNoi', 'hanoi', '/data/brand/brand.jpg', NULL, 1, 0, NULL, NULL),
	('9623e013-47c1-42f0-9497-556c000302bb', 'BenTre', 'bentre', '/data/brand/brand.jpg', NULL, 1, 0, NULL, NULL),
	('9623e013-47c6-47a2-b3a4-29e8fa528b21', 'NgheAn', 'nghean', '/data/brand/brand.jpg', NULL, 1, 0, NULL, NULL),
	('9623e013-47ca-4aaa-bd2b-90f721af5aeb', 'LongAn', 'longan', '/data/brand/brand.jpg', NULL, 1, 0, NULL, NULL),
	('9623e013-47cf-42e7-a926-977cf633eb47', 'CaMau', 'camau', '/data/brand/brand.jpg', NULL, 1, 0, NULL, NULL),
	('9623e013-47d3-464b-a28b-706f44b97495', 'HaGiang', 'hagiang', '/data/brand/brand.jpg', NULL, 1, 0, NULL, NULL),
	('9623e013-47d7-425d-a0db-56b6db44744f', 'ThanhHoa', 'thanhhoa', '/data/brand/brand.jpg', NULL, 1, 0, NULL, NULL);
...
INSERT INTO `sc_shop_brand_store` (`brand_id`, `store_id`) VALUES
	('9623e013-47b0-4d6c-804b-f785078e6f3d', '1'),
	('9623e013-47b8-414b-ba9c-e9069e0410c4', '1'),
	('9623e013-47bd-4330-a977-2ba6b2e3bb30', '1'),
	('9623e013-47c1-42f0-9497-556c000302bb', '1'),
	('9623e013-47c6-47a2-b3a4-29e8fa528b21', '1'),
	('9623e013-47ca-4aaa-bd2b-90f721af5aeb', '1'),
	('9623e013-47cf-42e7-a926-977cf633eb47', '1'),
	('9623e013-47d3-464b-a28b-706f44b97495', '1'),
	('9623e013-47d7-425d-a0db-56b6db44744f', '1');
...
INSERT INTO `sc_shop_category` (`id`, `image`, `alias`, `parent`, `top`, `status`, `sort`, `created_at`, `updated_at`) VALUES
	('9623e013-419b-4674-96e7-c899292dabe6', '/data/category/category.jpg', 'am-thuc', '0', 1, 1, 0, NULL, NULL),
	('9623e013-41a4-498b-8bc3-4b54b2d9db71', '/data/category/category.jpg', 'trai-cay', '0', 1, 1, 0, NULL, NULL),
	('9623e013-41aa-4194-8dfd-f223c68eb695', '/data/category/category.jpg', 'thu-cong-my-nghe', '0', 1, 1, 0, NULL, NULL),
	('9623e013-41ae-416e-b46c-de9f73dab7a6', '/data/category/category.jpg', 'bun-pho', '9623e013-419b-4674-96e7-c899292dabe6', 1, 1, 0, NULL, NULL),
	('9623e013-41b3-4eb4-9849-5e0415600736', '/data/category/category.jpg', 'banh-my', '9623e013-419b-4674-96e7-c899292dabe6', 1, 1, 0, NULL, NULL),
	('9623e013-41b7-4164-9427-8c81200e0c6a', '/data/category/category.jpg', 'trai-cay-nam-bo', '9623e013-41a4-498b-8bc3-4b54b2d9db71', 1, 1, 0, NULL, NULL),
	('9623e013-41bb-49c4-8e97-8f5fd6b5d3fb', '/data/category/category.jpg', 'trai-cay-mien-bac', '9623e013-41a4-498b-8bc3-4b54b2d9db71', 1, 1, 0, NULL, NULL),
	('9623e013-41c0-47d4-918a-a3640b895587', '/data/category/category.jpg', 'che-thai-nguyen', '9623e013-41a4-498b-8bc3-4b54b2d9db71', 0, 1, 0, NULL, NULL),
	('9623e013-41c4-46d6-b3d8-6b199f6b23fb', '/data/category/category.jpg', 'toi-ly-son', '9623e013-41a4-498b-8bc3-4b54b2d9db71', 0, 1, 0, NULL, NULL),
	('9623e013-41c8-4b83-a57b-a78e3e817847', '/data/category/category.jpg', 'gom-bat-trang', '9623e013-41aa-4194-8dfd-f223c68eb695', 1, 1, 0, NULL, NULL),
	('9623e013-41cd-4216-bcbb-f52dc92928a9', '/data/category/category.jpg', 'tranh-dong-ho', '9623e013-41aa-4194-8dfd-f223c68eb695', 0, 1, 0, NULL, NULL),
	('9623e013-41d1-49a2-8cfe-789b49d968d5', '/data/category/category.jpg', 'du-lich', '9623e013-41aa-4194-8dfd-f223c68eb695', 0, 1, 0, NULL, NULL),
	('9623e013-41d5-45ce-8c61-6556547bceea', '/data/category/category.jpg', 'nhac-co-truyen', '9623e013-41a4-498b-8bc3-4b54b2d9db71', 0, 1, 0, NULL, NULL);
...
INSERT INTO `sc_shop_category_description` (`category_id`, `lang`, `title`, `keyword`, `description`) VALUES
	('9623e013-419b-4674-96e7-c899292dabe6', 'en', 'Am Thuc', NULL, NULL),
	('9623e013-419b-4674-96e7-c899292dabe6', 'vi', 'Am Thuc', NULL, NULL),
	('9623e013-41a4-498b-8bc3-4b54b2d9db71', 'en', 'Trai Cay', NULL, NULL),
	('9623e013-41a4-498b-8bc3-4b54b2d9db71', 'vi', 'Trai Cay', NULL, NULL),
	('9623e013-41aa-4194-8dfd-f223c68eb695', 'en', 'Thu Cong My Nghe', NULL, NULL),
	('9623e013-41aa-4194-8dfd-f223c68eb695', 'vi', 'Thu Cong My Nghe', NULL, NULL),
	('9623e013-41ae-416e-b46c-de9f73dab7a6', 'en', 'Bun Pho', NULL, NULL),
	('9623e013-41ae-416e-b46c-de9f73dab7a6', 'vi', 'Bun Pho', NULL, NULL),
	('9623e013-41b3-4eb4-9849-5e0415600736', 'en', 'Banh My', NULL, NULL),
	('9623e013-41b3-4eb4-9849-5e0415600736', 'vi', 'Banh My', NULL, NULL),
	('9623e013-41b7-4164-9427-8c81200e0c6a', 'en', 'Trai Cay Nam Bo', NULL, NULL),
	('9623e013-41b7-4164-9427-8c81200e0c6a', 'vi', 'Trai Cay Nam Bo', NULL, NULL),
	('9623e013-41bb-49c4-8e97-8f5fd6b5d3fb', 'en', 'Trai Cay Mien Bac', NULL, NULL),
	('9623e013-41bb-49c4-8e97-8f5fd6b5d3fb', 'vi', 'Trai Cay Mien Bac', NULL, NULL),
	('9623e013-41c0-47d4-918a-a3640b895587', 'en', 'Che Thai Nguyen', NULL, NULL),
	('9623e013-41c0-47d4-918a-a3640b895587', 'vi', 'Che Thai Nguyen', NULL, NULL),
	('9623e013-41c4-46d6-b3d8-6b199f6b23fb', 'en', 'Toi Ly Son', NULL, NULL),
	('9623e013-41c4-46d6-b3d8-6b199f6b23fb', 'vi', 'Toi Ly Son', NULL, NULL),
	('9623e013-41c8-4b83-a57b-a78e3e817847', 'en', 'Gom Bat Trang', NULL, NULL),
	('9623e013-41c8-4b83-a57b-a78e3e817847', 'vi', 'Gom Bat Trang', NULL, NULL),
	('9623e013-41cd-4216-bcbb-f52dc92928a9', 'en', 'Tranh Dong Ho', NULL, NULL),
	('9623e013-41cd-4216-bcbb-f52dc92928a9', 'vi', 'Tranh Dong Ho', NULL, NULL),
	('9623e013-41d1-49a2-8cfe-789b49d968d5', 'en', 'Du Lich', NULL, NULL),
	('9623e013-41d1-49a2-8cfe-789b49d968d5', 'vi', 'Du Lich', NULL, NULL),
	('9623e013-41d5-45ce-8c61-6556547bceea', 'en', 'Nhac Co Truyen', NULL, NULL),
	('9623e013-41d5-45ce-8c61-6556547bceea', 'vi', 'Nhac Co Truyen', NULL, NULL);
...
INSERT INTO `sc_shop_category_store` (`category_id`, `store_id`) VALUES
	('9623e013-419b-4674-96e7-c899292dabe6', '1'),
	('9623e013-41a4-498b-8bc3-4b54b2d9db71', '1'),
	('9623e013-41aa-4194-8dfd-f223c68eb695', '1'),
	('9623e013-41ae-416e-b46c-de9f73dab7a6', '1'),
	('9623e013-41b3-4eb4-9849-5e0415600736', '1'),
	('9623e013-41b7-4164-9427-8c81200e0c6a', '1'),
	('9623e013-41bb-49c4-8e97-8f5fd6b5d3fb', '1'),
	('9623e013-41c0-47d4-918a-a3640b895587', '1'),
	('9623e013-41c4-46d6-b3d8-6b199f6b23fb', '1'),
	('9623e013-41c8-4b83-a57b-a78e3e817847', '1'),
	('9623e013-41cd-4216-bcbb-f52dc92928a9', '1'),
	('9623e013-41d1-49a2-8cfe-789b49d968d5', '1'),
	('9623e013-41d5-45ce-8c61-6556547bceea', '1');
...
INSERT INTO `sc_shop_link` (`id`, `name`, `url`, `target`, `group`, `module`, `status`, `sort`, `created_at`, `updated_at`) VALUES
	('9623e011-f85c-4acd-8385-96e9b2fad03a', 'front.about', 'route::page.detail::about', '_self', 'menu', '', 1, 50, NULL, NULL),
	('9623e012-4899-467a-81a7-ae39ee55254a', 'front.home', 'route::home', '_self', 'menu', '', 1, 10, NULL, NULL),
	('9623e012-48a1-444a-86df-cee39c8cceee', 'front.shop', 'route::shop', '_self', 'menu', '', 1, 20, NULL, NULL),
	('9623e012-48a6-4f7a-a957-e6a9f446ed05', 'front.blog', 'route::news', '_self', 'menu', '', 1, 30, NULL, NULL),
	('9623e012-48aa-4ca0-b013-f7fb67b2cc06', 'front.contact', 'route::contact', '_self', 'menu', '', 1, 40, NULL, NULL),
	('9623e012-48af-4f61-89e5-18034ad2b20b', 'front.my_profile', 'route::login', '_self', 'footer', '', 1, 60, NULL, NULL),
	('9623e012-48b3-4da2-a3d8-f415fd05fead', 'front.compare_page', 'route::compare', '_self', 'footer', '', 1, 70, NULL, NULL),
	('9623e012-48b7-455c-b69e-4649a37bd605', 'front.wishlist_page', 'route::wishlist', '_self', 'footer', '', 1, 80, NULL, NULL);
...
INSERT INTO `sc_shop_link_store` (`link_id`, `store_id`) VALUES
	('9623e011-f85c-4acd-8385-96e9b2fad03a', '1'),
	('9623e012-4899-467a-81a7-ae39ee55254a', '1'),
	('9623e012-48a1-444a-86df-cee39c8cceee', '1'),
	('9623e012-48a6-4f7a-a957-e6a9f446ed05', '1'),
	('9623e012-48aa-4ca0-b013-f7fb67b2cc06', '1'),
	('9623e012-48af-4f61-89e5-18034ad2b20b', '1'),
	('9623e012-48b3-4da2-a3d8-f415fd05fead', '1'),
	('9623e012-48b7-455c-b69e-4649a37bd605', '1');
...
INSERT INTO `sc_shop_news` (`id`, `image`, `alias`, `sort`, `status`, `created_at`, `updated_at`) VALUES
	('9623e013-3b45-4a96-b8e6-54f911d9aecf', '/data/content/blog-1.jpg', 'demo-scart-blog-1', 0, 1, '2022-04-24 20:51:13', NULL),
	('9623e013-3c79-4fd9-b36a-768a3651bf75', '/data/content/blog-2.jpg', 'demo-scart-blog-2', 0, 1, '2022-04-24 20:51:13', NULL),
	('9623e013-3c81-49eb-b353-721d9de76586', '/data/content/blog-3.jpg', 'demo-scart-blog-3', 0, 1, '2022-04-24 20:51:13', NULL),
	('9623e013-3c87-4ac9-977a-22cb62200252', '/data/content/blog-4.jpg', 'demo-scart-blog-4', 0, 1, '2022-04-24 20:51:13', NULL),
	('9623e013-3c8d-4b14-942d-adf32c046248', '/data/content/blog-5.jpg', 'demo-scart-blog-5', 0, 1, '2022-04-24 20:51:13', NULL),
	('9623e013-3c93-4681-bee8-16702112bf67', '/data/content/blog-6.jpg', 'demo-scart-blog-6', 0, 1, '2022-04-24 20:51:13', NULL);
...
INSERT INTO `sc_shop_news_description` (`news_id`, `lang`, `title`, `keyword`, `description`, `content`) VALUES
	('9623e013-3b45-4a96-b8e6-54f911d9aecf', 'en', 'Easy Polo Black Edition 1', NULL, NULL, '<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.<img alt="" src="/data/product/product-10.png" style="width: 150px; float: right; margin: 10px;" /></p>\r\n                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>'),
	('9623e013-3b45-4a96-b8e6-54f911d9aecf', 'vi', 'Easy Polo Black Edition 1', NULL, NULL, '<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.<img alt="" src="/data/product/product-10.png" style="width: 150px; float: right; margin: 10px;" /></p>\r\n                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>'),
	('9623e013-3c79-4fd9-b36a-768a3651bf75', 'en', 'Easy Polo Black Edition 2', NULL, NULL, '<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.<img alt="" src="/data/product/product-10.png" style="width: 150px; float: right; margin: 10px;" /></p>\r\n                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>'),
	('9623e013-3c79-4fd9-b36a-768a3651bf75', 'vi', 'Easy Polo Black Edition 2', NULL, NULL, '<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.<img alt="" src="/data/product/product-10.png" style="width: 150px; float: right; margin: 10px;" /></p>\r\n                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>'),
	('9623e013-3c81-49eb-b353-721d9de76586', 'en', 'Easy Polo Black Edition 3', NULL, NULL, '<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.<img alt="" src="/data/product/product-10.png" style="width: 150px; float: right; margin: 10px;" /></p>\r\n                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>'),
	('9623e013-3c81-49eb-b353-721d9de76586', 'vi', 'Easy Polo Black Edition 3', NULL, NULL, '<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.<img alt="" src="/data/product/product-10.png" style="width: 150px; float: right; margin: 10px;" /></p>\r\n                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>'),
	('9623e013-3c87-4ac9-977a-22cb62200252', 'en', 'Easy Polo Black Edition 4', NULL, NULL, '<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.<img alt="" src="/data/product/product-10.png" style="width: 150px; float: right; margin: 10px;" /></p>\r\n                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>'),
	('9623e013-3c87-4ac9-977a-22cb62200252', 'vi', 'Easy Polo Black Edition 4', NULL, NULL, '<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.<img alt="" src="/data/product/product-10.png" style="width: 150px; float: right; margin: 10px;" /></p>\r\n                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>'),
	('9623e013-3c8d-4b14-942d-adf32c046248', 'en', 'Easy Polo Black Edition 5', NULL, NULL, '<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.<img alt="" src="/data/product/product-10.png" style="width: 150px; float: right; margin: 10px;" /></p>\r\n                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>'),
	('9623e013-3c8d-4b14-942d-adf32c046248', 'vi', 'Easy Polo Black Edition 5', NULL, NULL, '<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.<img alt="" src="/data/product/product-10.png" style="width: 150px; float: right; margin: 10px;" /></p>\r\n                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>'),
	('9623e013-3c93-4681-bee8-16702112bf67', 'en', 'Easy Polo Black Edition 6', NULL, NULL, '<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.<img alt="" src="/data/product/product-10.png" style="width: 150px; float: right; margin: 10px;" /></p>\r\n                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>'),
	('9623e013-3c93-4681-bee8-16702112bf67', 'vi', 'Easy Polo Black Edition 6', NULL, NULL, '<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.<img alt="" src="/data/product/product-10.png" style="width: 150px; float: right; margin: 10px;" /></p>\r\n                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>');
...
INSERT INTO `sc_shop_news_store` (`news_id`, `store_id`) VALUES
	('9623e013-3b45-4a96-b8e6-54f911d9aecf', '1'),
	('9623e013-3c79-4fd9-b36a-768a3651bf75', '1'),
	('9623e013-3c81-49eb-b353-721d9de76586', '1'),
	('9623e013-3c87-4ac9-977a-22cb62200252', '1'),
	('9623e013-3c8d-4b14-942d-adf32c046248', '1'),
	('9623e013-3c93-4681-bee8-16702112bf67', '1');
...
INSERT INTO `sc_shop_page` (`id`, `image`, `alias`, `status`, `created_at`, `updated_at`) VALUES
	('9623e012-3428-4ab0-bd9f-91212af76636', '', 'about', 1, NULL, NULL);
...
INSERT INTO `sc_shop_page_description` (`page_id`, `lang`, `title`, `keyword`, `description`, `content`) VALUES
	('9623e012-3428-4ab0-bd9f-91212af76636', 'en', 'About', '', '', '<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.<img alt="" src="/data/product/product-2.png" style="width: 150px; float: right; margin: 10px;" /></p>\n            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>'),
	('9623e012-3428-4ab0-bd9f-91212af76636', 'vi', 'Giới thiệu', '', '', '<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.<img alt="" src="/data/product/product-2.png" style="width: 150px; float: right; margin: 10px;" /></p>\n            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>');
...
INSERT INTO `sc_shop_page_store` (`page_id`, `store_id`) VALUES
	('9623e012-3428-4ab0-bd9f-91212af76636', '1');
...
INSERT INTO `sc_shop_product` (`id`, `sku`, `upc`, `ean`, `jan`, `isbn`, `mpn`, `image`, `brand_id`, `supplier_id`, `price`, `cost`, `stock`, `sold`, `minimum`, `weight_class`, `weight`, `length_class`, `length`, `width`, `height`, `kind`, `property`, `tax_id`, `status`, `approve`, `sort`, `view`, `alias`, `date_lastview`, `date_available`, `created_at`, `updated_at`) VALUES
	('9623e013-4cb3-4053-bd6e-112b97848d79', 'PHO-BO', NULL, NULL, NULL, NULL, NULL, '/data/product/product-1.png', '9623e013-47c1-42f0-9497-556c000302bb', '9623e013-45cf-4291-9c22-9616ef5853cb', 80.00, 0.00, 100, 0, 0, NULL, 0.00, NULL, 0.00, 0.00, 0.00, 0, 'physical', 'auto', 1, 1, 0, 0, 'pho-bo', NULL, NULL, NULL, NULL),
	('9623e013-4cbc-4480-960f-89529f34af76', 'NEM-NUONG', NULL, NULL, NULL, NULL, NULL, '/data/product/product-2.png', '9623e013-47b8-414b-ba9c-e9069e0410c4', '9623e013-45cf-4291-9c22-9616ef5853cb', 100.00, 0.00, 100, 0, 0, NULL, 0.00, NULL, 0.00, 0.00, 0.00, 0, 'physical', 'auto', 1, 1, 0, 0, 'nem-nuong', NULL, NULL, NULL, NULL),
	('9623e013-4cc1-4326-b167-e2c5d8814c6f', 'BANH-GAI', NULL, NULL, NULL, NULL, NULL, '/data/product/product-3.png', '9623e013-47ca-4aaa-bd2b-90f721af5aeb', '9623e013-45c6-47ce-908c-45b359e979d0', 80.00, 0.00, 100, 0, 0, NULL, 0.00, NULL, 0.00, 0.00, 0.00, 0, 'physical', 'auto', 1, 1, 0, 0, 'banh-gai', NULL, NULL, NULL, NULL),
	('9623e013-4cc6-4714-b3b5-8a748d1c3bda', 'BUN-HUE', NULL, NULL, NULL, NULL, NULL, '/data/product/product-4.png', '9623e013-47bd-4330-a977-2ba6b2e3bb30', '9623e013-45c6-47ce-908c-45b359e979d0', 60.00, 0.00, 100, 0, 0, NULL, 0.00, NULL, 0.00, 0.00, 0.00, 2, 'physical', 'auto', 1, 1, 0, 0, 'bun-hue', NULL, NULL, NULL, NULL),
	('9623e013-4cca-46e4-b74a-c58c85eda9e7', 'BANH-TRANG', NULL, NULL, NULL, NULL, NULL, '/data/product/product-5.png', '9623e013-47ca-4aaa-bd2b-90f721af5aeb', '9623e013-45c6-47ce-908c-45b359e979d0', 100.00, 0.00, 100, 0, 0, NULL, 0.00, NULL, 0.00, 0.00, 0.00, 1, 'physical', 'auto', 1, 1, 0, 0, 'banh-trang', NULL, NULL, NULL, NULL),
	('9623e013-4cce-405b-b62f-b2e543e1f9c9', 'MUOI-TAY-NINH', NULL, NULL, NULL, NULL, NULL, '/data/product/product-6.png', '9623e013-47c6-47a2-b3a4-29e8fa528b21', '9623e013-45c6-47ce-908c-45b359e979d0', 80.00, 0.00, 100, 0, 0, NULL, 0.00, NULL, 0.00, 0.00, 0.00, 0, 'physical', 'auto', 1, 1, 0, 0, 'muoi-tay-ninh', NULL, NULL, NULL, NULL),
	('9623e013-4cd3-45a4-a2b2-103aa1e81030', 'NHAN-LONG', NULL, NULL, NULL, NULL, NULL, '/data/product/product-7.png', '9623e013-47c6-47a2-b3a4-29e8fa528b21', '9623e013-45cf-4291-9c22-9616ef5853cb', 60.00, 0.00, 100, 0, 0, NULL, 0.00, NULL, 0.00, 0.00, 0.00, 0, 'physical', 'auto', 1, 1, 0, 0, 'nhan-long', NULL, NULL, NULL, NULL),
	('9623e013-4cd7-49b8-9b7f-00763680b4e9', 'SAU-RIENG', NULL, NULL, NULL, NULL, NULL, '/data/product/product-8.png', '9623e013-47d7-425d-a0db-56b6db44744f', '9623e013-45c6-47ce-908c-45b359e979d0', 100.00, 0.00, 100, 0, 0, NULL, 0.00, NULL, 0.00, 0.00, 0.00, 0, 'physical', 'auto', 1, 1, 0, 0, 'sau-rieng', NULL, NULL, NULL, NULL),
	('9623e013-4cdc-44f3-8296-0b1163bf3786', 'BIA-SAIGON', NULL, NULL, NULL, NULL, NULL, '/data/product/product-9.png', '9623e013-47ca-4aaa-bd2b-90f721af5aeb', '9623e013-45c6-47ce-908c-45b359e979d0', 100.00, 0.00, 100, 0, 0, NULL, 0.00, NULL, 0.00, 0.00, 0.00, 0, 'physical', 'auto', 1, 1, 0, 0, 'bia-saigon', NULL, NULL, NULL, NULL),
	('9623e013-4ce0-4f1c-8fe7-c27c1fc561a6', 'BIA-HANOI', NULL, NULL, NULL, NULL, NULL, '/data/product/product-10.png', '9623e013-47c6-47a2-b3a4-29e8fa528b21', '9623e013-45cf-4291-9c22-9616ef5853cb', 100.00, 0.00, 100, 0, 0, NULL, 0.00, NULL, 0.00, 0.00, 0.00, 1, 'physical', 'auto', 1, 1, 0, 0, 'bia-hanoi', NULL, NULL, NULL, NULL),
	('9623e013-4ce4-440f-97b4-d4a12cc86d58', 'NUOC-MAM', NULL, NULL, NULL, NULL, NULL, '/data/product/product-11.png', '9623e013-47b8-414b-ba9c-e9069e0410c4', '9623e013-45c6-47ce-908c-45b359e979d0', 60.00, 0.00, 100, 0, 0, NULL, 0.00, NULL, 0.00, 0.00, 0.00, 0, 'physical', 'auto', 1, 1, 0, 0, 'nuoc-mam', NULL, NULL, NULL, NULL),
	('9623e013-4ce8-4e40-804b-ad17f5105b81', 'BANH-MYCAY', NULL, NULL, NULL, NULL, NULL, '/data/product/product-12.png', '9623e013-47b8-414b-ba9c-e9069e0410c4', '9623e013-45c6-47ce-908c-45b359e979d0', 100.00, 0.00, 100, 0, 0, NULL, 0.00, NULL, 0.00, 0.00, 0.00, 0, 'physical', 'auto', 1, 1, 0, 0, 'banh-mycay', NULL, NULL, NULL, NULL),
	('9623e013-4ced-4680-82f9-ce3302219061', 'HU-TIEU', NULL, NULL, NULL, NULL, NULL, '/data/product/product-13.png', '9623e013-47b0-4d6c-804b-f785078e6f3d', '9623e013-45cf-4291-9c22-9616ef5853cb', 60.00, 0.00, 100, 0, 0, NULL, 0.00, NULL, 0.00, 0.00, 0.00, 0, 'physical', 'auto', 1, 1, 0, 0, 'hu-tieu', NULL, NULL, NULL, NULL),
	('9623e013-4cf1-4dfb-8ad5-6fd63e77dd00', 'CANH-CHUA', NULL, NULL, NULL, NULL, NULL, '/data/product/product-14.png', '9623e013-47b0-4d6c-804b-f785078e6f3d', '9623e013-45c6-47ce-908c-45b359e979d0', 60.00, 0.00, 100, 0, 0, NULL, 0.00, NULL, 0.00, 0.00, 0.00, 2, 'physical', 'auto', 1, 1, 0, 0, 'canh-chua', NULL, NULL, NULL, NULL),
	('9623e013-4cf5-4bf9-bd31-bb4ad55732bb', 'MANG-CUT', NULL, NULL, NULL, NULL, NULL, '/data/product/product-15.png', '9623e013-47cf-42e7-a926-977cf633eb47', '9623e013-45c6-47ce-908c-45b359e979d0', 80.00, 0.00, 100, 0, 0, NULL, 0.00, NULL, 0.00, 0.00, 0.00, 1, 'physical', 'auto', 1, 1, 0, 0, 'mang-cut', NULL, NULL, NULL, NULL),
	('9623e013-4cfa-4c86-833b-893e6c6a14b4', 'CAM-VINH', NULL, NULL, NULL, NULL, NULL, '/data/product/product-16.png', '9623e013-47ca-4aaa-bd2b-90f721af5aeb', '9623e013-45cf-4291-9c22-9616ef5853cb', 80.00, 0.00, 100, 0, 0, NULL, 0.00, NULL, 0.00, 0.00, 0.00, 0, 'physical', 'auto', 1, 1, 0, 0, 'cam-vinh', NULL, NULL, NULL, NULL),
	('9623e013-4cfe-40e9-bfa5-ad743ac9bccb', 'VAI-THIEU', NULL, NULL, NULL, NULL, NULL, '/data/product/product-17.png', '9623e013-47c6-47a2-b3a4-29e8fa528b21', '9623e013-45c6-47ce-908c-45b359e979d0', 60.00, 0.00, 100, 0, 0, NULL, 0.00, NULL, 0.00, 0.00, 0.00, 0, 'physical', 'auto', 1, 1, 0, 0, 'vai-thieu', NULL, NULL, NULL, NULL),
	('9623e013-4d02-4eab-8d9e-95c33c91d17e', 'NON-LA', NULL, NULL, NULL, NULL, NULL, '/data/product/product-18.png', '9623e013-47d3-464b-a28b-706f44b97495', '9623e013-45cf-4291-9c22-9616ef5853cb', 60.00, 0.00, 100, 0, 0, NULL, 0.00, NULL, 0.00, 0.00, 0.00, 0, 'physical', 'auto', 1, 1, 0, 0, 'non-la', NULL, NULL, NULL, NULL),
	('9623e013-4d06-4b95-9fa6-6d2321c28610', 'AO-DAI', NULL, NULL, NULL, NULL, NULL, '/data/product/product-19.png', '9623e013-47c6-47a2-b3a4-29e8fa528b21', '9623e013-45cf-4291-9c22-9616ef5853cb', 80.00, 0.00, 100, 0, 0, NULL, 0.00, NULL, 0.00, 0.00, 0.00, 2, 'physical', 'auto', 1, 1, 0, 0, 'ao-dai', NULL, NULL, NULL, NULL),
	('9623e013-4d0b-4fe9-8569-2ca6d2e8ab1d', 'XOAI-CAT', NULL, NULL, NULL, NULL, NULL, '/data/product/product-20.png', '9623e013-47d7-425d-a0db-56b6db44744f', '9623e013-45cf-4291-9c22-9616ef5853cb', 60.00, 0.00, 100, 0, 0, NULL, 0.00, NULL, 0.00, 0.00, 0.00, 1, 'physical', 'auto', 1, 1, 0, 0, 'xoai-cat', NULL, NULL, NULL, NULL),
	('9623e013-4d0f-4b34-bb10-309824e9c8fd', 'COM-NIU', NULL, NULL, NULL, NULL, NULL, '/data/product/product-21.png', '9623e013-47ca-4aaa-bd2b-90f721af5aeb', '9623e013-45c6-47ce-908c-45b359e979d0', 60.00, 0.00, 100, 0, 0, NULL, 0.00, NULL, 0.00, 0.00, 0.00, 0, 'physical', 'auto', 1, 1, 0, 0, 'com-niu', NULL, NULL, NULL, NULL),
	('9623e013-4d13-46de-a0a6-f83c7440ba7e', 'NHAN-LONG-HUNG-YEN', NULL, NULL, NULL, NULL, NULL, '/data/product/product-22.png', '9623e013-47c1-42f0-9497-556c000302bb', '9623e013-45c6-47ce-908c-45b359e979d0', 60.00, 0.00, 100, 0, 0, NULL, 0.00, NULL, 0.00, 0.00, 0.00, 0, 'physical', 'auto', 1, 1, 0, 0, 'nhan-long-hung-yen', NULL, NULL, NULL, NULL),
	('9623e013-4d18-4453-9a09-b78715c437b6', 'VAI-THIEU-LUC-NGAN', NULL, NULL, NULL, NULL, NULL, '/data/product/product-23.png', '9623e013-47c6-47a2-b3a4-29e8fa528b21', '9623e013-45c6-47ce-908c-45b359e979d0', 80.00, 0.00, 100, 0, 0, NULL, 0.00, NULL, 0.00, 0.00, 0.00, 2, 'physical', 'auto', 1, 1, 0, 0, 'vai-thieu-luc-ngan', NULL, NULL, NULL, NULL),
	('9623e013-4d1c-4b34-af6e-2034e19457fc', 'NEM-CHUA-THANH-HOA', NULL, NULL, NULL, NULL, NULL, '/data/product/product-24.png', '9623e013-47d7-425d-a0db-56b6db44744f', '9623e013-45cf-4291-9c22-9616ef5853cb', 100.00, 0.00, 100, 0, 0, NULL, 0.00, NULL, 0.00, 0.00, 0.00, 0, 'physical', 'auto', 1, 1, 0, 0, 'nem-chua-thanh-hoa', NULL, NULL, NULL, NULL);
...
INSERT INTO `sc_shop_product_attribute` (`id`, `name`, `attribute_group_id`, `product_id`, `add_price`, `sort`, `status`) VALUES
	(1, 'Blue', 1, '9623e013-4d1c-4b34-af6e-2034e19457fc', 5.00, 0, 1),
	(2, 'White', 1, '9623e013-4d1c-4b34-af6e-2034e19457fc', 0.00, 0, 1),
	(3, 'S', 2, '9623e013-4d1c-4b34-af6e-2034e19457fc', 2.00, 0, 1),
	(4, 'XL', 2, '9623e013-4d1c-4b34-af6e-2034e19457fc', 3.00, 0, 1),
	(5, 'Blue', 1, '9623e013-4ce8-4e40-804b-ad17f5105b81', 10.00, 0, 1),
	(6, 'Red', 1, '9623e013-4ce8-4e40-804b-ad17f5105b81', 0.00, 0, 1),
	(7, 'S', 2, '9623e013-4ce8-4e40-804b-ad17f5105b81', 0.00, 0, 1),
	(8, 'M', 2, '9623e013-4ce8-4e40-804b-ad17f5105b81', 0.00, 0, 1);
...
INSERT INTO `sc_shop_product_build` (`build_id`, `product_id`, `quantity`) VALUES
	('9623e013-4cca-46e4-b74a-c58c85eda9e7', '9623e013-4cc1-4326-b167-e2c5d8814c6f', 1),
	('9623e013-4cca-46e4-b74a-c58c85eda9e7', '9623e013-4cd3-45a4-a2b2-103aa1e81030', 2),
	('9623e013-4ce0-4f1c-8fe7-c27c1fc561a6', '9623e013-4ced-4680-82f9-ce3302219061', 1),
	('9623e013-4ce0-4f1c-8fe7-c27c1fc561a6', '9623e013-4cfe-40e9-bfa5-ad743ac9bccb', 2),
	('9623e013-4cf5-4bf9-bd31-bb4ad55732bb', '9623e013-4cf1-4dfb-8ad5-6fd63e77dd00', 2),
	('9623e013-4cf5-4bf9-bd31-bb4ad55732bb', '9623e013-4cfa-4c86-833b-893e6c6a14b4', 1),
	('9623e013-4d0b-4fe9-8569-2ca6d2e8ab1d', '9623e013-4cc1-4326-b167-e2c5d8814c6f', 2),
	('9623e013-4d0b-4fe9-8569-2ca6d2e8ab1d', '9623e013-4ced-4680-82f9-ce3302219061', 2);
...
INSERT INTO `sc_shop_product_category` (`product_id`, `category_id`) VALUES
	('9623e013-4cb3-4053-bd6e-112b97848d79', '9623e013-41b7-4164-9427-8c81200e0c6a'),
	('9623e013-4cb3-4053-bd6e-112b97848d79', '9623e013-41c8-4b83-a57b-a78e3e817847'),
	('9623e013-4cb3-4053-bd6e-112b97848d79', '9623e013-41d5-45ce-8c61-6556547bceea'),
	('9623e013-4cbc-4480-960f-89529f34af76', '9623e013-41d5-45ce-8c61-6556547bceea'),
	('9623e013-4cc1-4326-b167-e2c5d8814c6f', '9623e013-41cd-4216-bcbb-f52dc92928a9'),
	('9623e013-4cc6-4714-b3b5-8a748d1c3bda', '9623e013-41cd-4216-bcbb-f52dc92928a9'),
	('9623e013-4cca-46e4-b74a-c58c85eda9e7', '9623e013-41cd-4216-bcbb-f52dc92928a9'),
	('9623e013-4cce-405b-b62f-b2e543e1f9c9', '9623e013-41cd-4216-bcbb-f52dc92928a9'),
	('9623e013-4cd3-45a4-a2b2-103aa1e81030', '9623e013-41d1-49a2-8cfe-789b49d968d5'),
	('9623e013-4cd7-49b8-9b7f-00763680b4e9', '9623e013-41c8-4b83-a57b-a78e3e817847'),
	('9623e013-4cdc-44f3-8296-0b1163bf3786', '9623e013-41b7-4164-9427-8c81200e0c6a'),
	('9623e013-4ce0-4f1c-8fe7-c27c1fc561a6', '9623e013-41cd-4216-bcbb-f52dc92928a9'),
	('9623e013-4ce4-440f-97b4-d4a12cc86d58', '9623e013-41c8-4b83-a57b-a78e3e817847'),
	('9623e013-4ce8-4e40-804b-ad17f5105b81', '9623e013-41c4-46d6-b3d8-6b199f6b23fb'),
	('9623e013-4ced-4680-82f9-ce3302219061', '9623e013-41b3-4eb4-9849-5e0415600736'),
	('9623e013-4cf1-4dfb-8ad5-6fd63e77dd00', '9623e013-41cd-4216-bcbb-f52dc92928a9'),
	('9623e013-4cf5-4bf9-bd31-bb4ad55732bb', '9623e013-41b7-4164-9427-8c81200e0c6a'),
	('9623e013-4cfa-4c86-833b-893e6c6a14b4', '9623e013-41c4-46d6-b3d8-6b199f6b23fb'),
	('9623e013-4cfe-40e9-bfa5-ad743ac9bccb', '9623e013-41c4-46d6-b3d8-6b199f6b23fb'),
	('9623e013-4d02-4eab-8d9e-95c33c91d17e', '9623e013-41c4-46d6-b3d8-6b199f6b23fb'),
	('9623e013-4d06-4b95-9fa6-6d2321c28610', '9623e013-41b7-4164-9427-8c81200e0c6a'),
	('9623e013-4d0b-4fe9-8569-2ca6d2e8ab1d', '9623e013-41cd-4216-bcbb-f52dc92928a9'),
	('9623e013-4d0f-4b34-bb10-309824e9c8fd', '9623e013-41c8-4b83-a57b-a78e3e817847'),
	('9623e013-4d13-46de-a0a6-f83c7440ba7e', '9623e013-41c8-4b83-a57b-a78e3e817847'),
	('9623e013-4d18-4453-9a09-b78715c437b6', '9623e013-41d1-49a2-8cfe-789b49d968d5'),
	('9623e013-4d1c-4b34-af6e-2034e19457fc', '9623e013-41c4-46d6-b3d8-6b199f6b23fb');
...
INSERT INTO `sc_shop_product_description` (`product_id`, `lang`, `name`, `keyword`, `description`, `content`) VALUES
	('9623e013-4cb3-4053-bd6e-112b97848d79', 'en', 'Pho Bo', NULL, NULL, '<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.<img alt="" src="/data/product/product-10.png" style="width: 150px; float: right; margin: 10px;" /></p>\r\n                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>'),
	('9623e013-4cb3-4053-bd6e-112b97848d79', 'vi', 'Pho Bo', NULL, NULL, '<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.<img alt="" src="/data/product/product-10.png" style="width: 150px; float: right; margin: 10px;" /></p>\r\n                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>'),
	('9623e013-4cbc-4480-960f-89529f34af76', 'en', 'Nem Nuong', NULL, NULL, '<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.<img alt="" src="/data/product/product-10.png" style="width: 150px; float: right; margin: 10px;" /></p>\r\n                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>'),
	('9623e013-4cbc-4480-960f-89529f34af76', 'vi', 'Nem Nuong', NULL, NULL, '<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.<img alt="" src="/data/product/product-10.png" style="width: 150px; float: right; margin: 10px;" /></p>\r\n                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>'),
	('9623e013-4cc1-4326-b167-e2c5d8814c6f', 'en', 'Banh Gai', NULL, NULL, '<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.<img alt="" src="/data/product/product-10.png" style="width: 150px; float: right; margin: 10px;" /></p>\r\n                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>'),
	('9623e013-4cc1-4326-b167-e2c5d8814c6f', 'vi', 'Banh Gai', NULL, NULL, '<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.<img alt="" src="/data/product/product-10.png" style="width: 150px; float: right; margin: 10px;" /></p>\r\n                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>'),
	('9623e013-4cc6-4714-b3b5-8a748d1c3bda', 'en', 'Bun Hue', NULL, NULL, '<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.<img alt="" src="/data/product/product-10.png" style="width: 150px; float: right; margin: 10px;" /></p>\r\n                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>'),
	('9623e013-4cc6-4714-b3b5-8a748d1c3bda', 'vi', 'Bun Hue', NULL, NULL, '<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.<img alt="" src="/data/product/product-10.png" style="width: 150px; float: right; margin: 10px;" /></p>\r\n                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>'),
	('9623e013-4cca-46e4-b74a-c58c85eda9e7', 'en', 'Banh Trang', NULL, NULL, '<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.<img alt="" src="/data/product/product-10.png" style="width: 150px; float: right; margin: 10px;" /></p>\r\n                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>'),
	('9623e013-4cca-46e4-b74a-c58c85eda9e7', 'vi', 'Banh Trang', NULL, NULL, '<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.<img alt="" src="/data/product/product-10.png" style="width: 150px; float: right; margin: 10px;" /></p>\r\n                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>'),
	('9623e013-4cce-405b-b62f-b2e543e1f9c9', 'en', 'Muoi Tay Ninh', NULL, NULL, '<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.<img alt="" src="/data/product/product-10.png" style="width: 150px; float: right; margin: 10px;" /></p>\r\n                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>'),
	('9623e013-4cce-405b-b62f-b2e543e1f9c9', 'vi', 'Muoi Tay Ninh', NULL, NULL, '<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.<img alt="" src="/data/product/product-10.png" style="width: 150px; float: right; margin: 10px;" /></p>\r\n                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>'),
	('9623e013-4cd3-45a4-a2b2-103aa1e81030', 'en', 'Nhan Long', NULL, NULL, '<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.<img alt="" src="/data/product/product-10.png" style="width: 150px; float: right; margin: 10px;" /></p>\r\n                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>'),
	('9623e013-4cd3-45a4-a2b2-103aa1e81030', 'vi', 'Nhan Long', NULL, NULL, '<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.<img alt="" src="/data/product/product-10.png" style="width: 150px; float: right; margin: 10px;" /></p>\r\n                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>'),
	('9623e013-4cd7-49b8-9b7f-00763680b4e9', 'en', 'Sau Rieng', NULL, NULL, '<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.<img alt="" src="/data/product/product-10.png" style="width: 150px; float: right; margin: 10px;" /></p>\r\n                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>'),
	('9623e013-4cd7-49b8-9b7f-00763680b4e9', 'vi', 'Sau Rieng', NULL, NULL, '<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.<img alt="" src="/data/product/product-10.png" style="width: 150px; float: right; margin: 10px;" /></p>\r\n                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>'),
	('9623e013-4cdc-44f3-8296-0b1163bf3786', 'en', 'Bia Saigon', NULL, NULL, '<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.<img alt="" src="/data/product/product-10.png" style="width: 150px; float: right; margin: 10px;" /></p>\r\n                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>'),
	('9623e013-4cdc-44f3-8296-0b1163bf3786', 'vi', 'Bia Saigon', NULL, NULL, '<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.<img alt="" src="/data/product/product-10.png" style="width: 150px; float: right; margin: 10px;" /></p>\r\n                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>'),
	('9623e013-4ce0-4f1c-8fe7-c27c1fc561a6', 'en', 'Bia Hanoi', NULL, NULL, '<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.<img alt="" src="/data/product/product-10.png" style="width: 150px; float: right; margin: 10px;" /></p>\r\n                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>'),
	('9623e013-4ce0-4f1c-8fe7-c27c1fc561a6', 'vi', 'Bia Hanoi', NULL, NULL, '<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.<img alt="" src="/data/product/product-10.png" style="width: 150px; float: right; margin: 10px;" /></p>\r\n                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>'),
	('9623e013-4ce4-440f-97b4-d4a12cc86d58', 'en', 'Nuoc Mam', NULL, NULL, '<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.<img alt="" src="/data/product/product-10.png" style="width: 150px; float: right; margin: 10px;" /></p>\r\n                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>'),
	('9623e013-4ce4-440f-97b4-d4a12cc86d58', 'vi', 'Nuoc Mam', NULL, NULL, '<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.<img alt="" src="/data/product/product-10.png" style="width: 150px; float: right; margin: 10px;" /></p>\r\n                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>'),
	('9623e013-4ce8-4e40-804b-ad17f5105b81', 'en', 'Banh Mycay', NULL, NULL, '<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.<img alt="" src="/data/product/product-10.png" style="width: 150px; float: right; margin: 10px;" /></p>\r\n                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>'),
	('9623e013-4ce8-4e40-804b-ad17f5105b81', 'vi', 'Banh Mycay', NULL, NULL, '<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.<img alt="" src="/data/product/product-10.png" style="width: 150px; float: right; margin: 10px;" /></p>\r\n                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>'),
	('9623e013-4ced-4680-82f9-ce3302219061', 'en', 'Hu Tieu', NULL, NULL, '<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.<img alt="" src="/data/product/product-10.png" style="width: 150px; float: right; margin: 10px;" /></p>\r\n                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>'),
	('9623e013-4ced-4680-82f9-ce3302219061', 'vi', 'Hu Tieu', NULL, NULL, '<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.<img alt="" src="/data/product/product-10.png" style="width: 150px; float: right; margin: 10px;" /></p>\r\n                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>'),
	('9623e013-4cf1-4dfb-8ad5-6fd63e77dd00', 'en', 'Canh Chua', NULL, NULL, '<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.<img alt="" src="/data/product/product-10.png" style="width: 150px; float: right; margin: 10px;" /></p>\r\n                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>'),
	('9623e013-4cf1-4dfb-8ad5-6fd63e77dd00', 'vi', 'Canh Chua', NULL, NULL, '<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.<img alt="" src="/data/product/product-10.png" style="width: 150px; float: right; margin: 10px;" /></p>\r\n                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>'),
	('9623e013-4cf5-4bf9-bd31-bb4ad55732bb', 'en', 'Mang Cut', NULL, NULL, '<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.<img alt="" src="/data/product/product-10.png" style="width: 150px; float: right; margin: 10px;" /></p>\r\n                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>'),
	('9623e013-4cf5-4bf9-bd31-bb4ad55732bb', 'vi', 'Mang Cut', NULL, NULL, '<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.<img alt="" src="/data/product/product-10.png" style="width: 150px; float: right; margin: 10px;" /></p>\r\n                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>'),
	('9623e013-4cfa-4c86-833b-893e6c6a14b4', 'en', 'Cam Vinh', NULL, NULL, '<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.<img alt="" src="/data/product/product-10.png" style="width: 150px; float: right; margin: 10px;" /></p>\r\n                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>'),
	('9623e013-4cfa-4c86-833b-893e6c6a14b4', 'vi', 'Cam Vinh', NULL, NULL, '<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.<img alt="" src="/data/product/product-10.png" style="width: 150px; float: right; margin: 10px;" /></p>\r\n                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>'),
	('9623e013-4cfe-40e9-bfa5-ad743ac9bccb', 'en', 'Vai Thieu', NULL, NULL, '<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.<img alt="" src="/data/product/product-10.png" style="width: 150px; float: right; margin: 10px;" /></p>\r\n                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>'),
	('9623e013-4cfe-40e9-bfa5-ad743ac9bccb', 'vi', 'Vai Thieu', NULL, NULL, '<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.<img alt="" src="/data/product/product-10.png" style="width: 150px; float: right; margin: 10px;" /></p>\r\n                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>'),
	('9623e013-4d02-4eab-8d9e-95c33c91d17e', 'en', 'Non La', NULL, NULL, '<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.<img alt="" src="/data/product/product-10.png" style="width: 150px; float: right; margin: 10px;" /></p>\r\n                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>'),
	('9623e013-4d02-4eab-8d9e-95c33c91d17e', 'vi', 'Non La', NULL, NULL, '<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.<img alt="" src="/data/product/product-10.png" style="width: 150px; float: right; margin: 10px;" /></p>\r\n                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>'),
	('9623e013-4d06-4b95-9fa6-6d2321c28610', 'en', 'Ao Dai', NULL, NULL, '<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.<img alt="" src="/data/product/product-10.png" style="width: 150px; float: right; margin: 10px;" /></p>\r\n                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>'),
	('9623e013-4d06-4b95-9fa6-6d2321c28610', 'vi', 'Ao Dai', NULL, NULL, '<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.<img alt="" src="/data/product/product-10.png" style="width: 150px; float: right; margin: 10px;" /></p>\r\n                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>'),
	('9623e013-4d0b-4fe9-8569-2ca6d2e8ab1d', 'en', 'Xoai Cat', NULL, NULL, '<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.<img alt="" src="/data/product/product-10.png" style="width: 150px; float: right; margin: 10px;" /></p>\r\n                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>'),
	('9623e013-4d0b-4fe9-8569-2ca6d2e8ab1d', 'vi', 'Xoai Cat', NULL, NULL, '<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.<img alt="" src="/data/product/product-10.png" style="width: 150px; float: right; margin: 10px;" /></p>\r\n                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>'),
	('9623e013-4d0f-4b34-bb10-309824e9c8fd', 'en', 'Com Niu', NULL, NULL, '<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.<img alt="" src="/data/product/product-10.png" style="width: 150px; float: right; margin: 10px;" /></p>\r\n                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>'),
	('9623e013-4d0f-4b34-bb10-309824e9c8fd', 'vi', 'Com Niu', NULL, NULL, '<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.<img alt="" src="/data/product/product-10.png" style="width: 150px; float: right; margin: 10px;" /></p>\r\n                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>'),
	('9623e013-4d13-46de-a0a6-f83c7440ba7e', 'en', 'Nhan Long Hung Yen', NULL, NULL, '<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.<img alt="" src="/data/product/product-10.png" style="width: 150px; float: right; margin: 10px;" /></p>\r\n                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>'),
	('9623e013-4d13-46de-a0a6-f83c7440ba7e', 'vi', 'Nhan Long Hung Yen', NULL, NULL, '<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.<img alt="" src="/data/product/product-10.png" style="width: 150px; float: right; margin: 10px;" /></p>\r\n                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>'),
	('9623e013-4d18-4453-9a09-b78715c437b6', 'en', 'Vai Thieu Luc Ngan', NULL, NULL, '<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.<img alt="" src="/data/product/product-10.png" style="width: 150px; float: right; margin: 10px;" /></p>\r\n                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>'),
	('9623e013-4d18-4453-9a09-b78715c437b6', 'vi', 'Vai Thieu Luc Ngan', NULL, NULL, '<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.<img alt="" src="/data/product/product-10.png" style="width: 150px; float: right; margin: 10px;" /></p>\r\n                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>'),
	('9623e013-4d1c-4b34-af6e-2034e19457fc', 'en', 'Nem Chua Thanh Hoa', NULL, NULL, '<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.<img alt="" src="/data/product/product-10.png" style="width: 150px; float: right; margin: 10px;" /></p>\r\n                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>'),
...
INSERT INTO `sc_shop_product_group` (`group_id`, `product_id`) VALUES
	('9623e013-4cc6-4714-b3b5-8a748d1c3bda', '9623e013-4cbc-4480-960f-89529f34af76'),
	('9623e013-4cc6-4714-b3b5-8a748d1c3bda', '9623e013-4cce-405b-b62f-b2e543e1f9c9'),
	('9623e013-4cf1-4dfb-8ad5-6fd63e77dd00', '9623e013-4cbc-4480-960f-89529f34af76'),
	('9623e013-4cf1-4dfb-8ad5-6fd63e77dd00', '9623e013-4ce8-4e40-804b-ad17f5105b81'),
	('9623e013-4d06-4b95-9fa6-6d2321c28610', '9623e013-4ce4-440f-97b4-d4a12cc86d58'),
	('9623e013-4d06-4b95-9fa6-6d2321c28610', '9623e013-4d0f-4b34-bb10-309824e9c8fd'),
	('9623e013-4d18-4453-9a09-b78715c437b6', '9623e013-4cc1-4326-b167-e2c5d8814c6f'),
	('9623e013-4d18-4453-9a09-b78715c437b6', '9623e013-4cd3-45a4-a2b2-103aa1e81030');
...
INSERT INTO `sc_shop_product_image` (`id`, `image`, `product_id`) VALUES
	('9623e013-4d21-497a-99be-4a9b81cc7710', '/data/product/product-2.png', '9623e013-4cb3-4053-bd6e-112b97848d79'),
	('9623e013-4d25-4844-94d0-d8f7c5f4c2ef', '/data/product/product-11.png', '9623e013-4cb3-4053-bd6e-112b97848d79'),
	('9623e013-4d29-4378-8dcf-2d2aafc5e3f5', '/data/product/product-8.png', '9623e013-4ce4-440f-97b4-d4a12cc86d58'),
	('9623e013-4d2e-4cee-aef5-7a87a3463e71', '/data/product/product-6.png', '9623e013-4cbc-4480-960f-89529f34af76'),
	('9623e013-4d32-4a7c-98a8-b7eae4c1e2ad', '/data/product/product-13.png', '9623e013-4ce4-440f-97b4-d4a12cc86d58'),
	('9623e013-4d36-41c1-819e-92dbce66d1cd', '/data/product/product-12.png', '9623e013-4cca-46e4-b74a-c58c85eda9e7'),
	('9623e013-4d3b-4951-ad22-d66ba5ece38a', '/data/product/product-17.png', '9623e013-4cca-46e4-b74a-c58c85eda9e7'),
	('9623e013-4d3f-4742-bbe1-3fdf2bddd639', '/data/product/product-11.png', '9623e013-4cbc-4480-960f-89529f34af76'),
	('9623e013-4d43-45b5-8e04-a9e839f1db55', '/data/product/product-5.png', '9623e013-4cbc-4480-960f-89529f34af76'),
	('9623e013-4d48-4af6-ab62-7a5e1916fd5b', '/data/product/product-12.png', '9623e013-4cdc-44f3-8296-0b1163bf3786'),
	('9623e013-4d4c-48fe-8221-757471c7b196', '/data/product/product-15.png', '9623e013-4cd7-49b8-9b7f-00763680b4e9'),
	('9623e013-4d50-4aea-b33f-a28debf5a4ea', '/data/product/product-19.png', '9623e013-4cd3-45a4-a2b2-103aa1e81030'),
	('9623e013-4d55-4969-aea4-d1435ce299bc', '/data/product/product-12.png', '9623e013-4cd3-45a4-a2b2-103aa1e81030'),
	('9623e013-4d59-4be7-b471-8f16dd7cd858', '/data/product/product-1.png', '9623e013-4cca-46e4-b74a-c58c85eda9e7'),
	('9623e013-4d5d-4083-bb5a-25871e611ed0', '/data/product/product-12.png', '9623e013-4cc6-4714-b3b5-8a748d1c3bda'),
	('9623e013-4d62-4ac1-ba60-3b1f63636895', '/data/product/product-7.png', '9623e013-4cf5-4bf9-bd31-bb4ad55732bb'),
	('9623e013-4d66-4a77-9298-41412d73823d', '/data/product/product-12.png', '9623e013-4cf5-4bf9-bd31-bb4ad55732bb'),
	('9623e013-4d6a-479f-9c94-9103816dd6d7', '/data/product/product-16.png', '9623e013-4cfe-40e9-bfa5-ad743ac9bccb'),
	('9623e013-4d6f-4d9a-b5c5-048bfa9f0071', '/data/product/product-6.png', '9623e013-4cfe-40e9-bfa5-ad743ac9bccb'),
	('9623e013-4d73-45a8-ab46-f65bb88113dc', '/data/product/product-12.png', '9623e013-4cfe-40e9-bfa5-ad743ac9bccb'),
	('9623e013-4d77-454c-ab1f-2f0587d42955', '/data/product/product-18.png', '9623e013-4d13-46de-a0a6-f83c7440ba7e'),
	('9623e013-4d7c-4d61-9b14-be4f47251d26', '/data/product/product-19.png', '9623e013-4d13-46de-a0a6-f83c7440ba7e'),
	('9623e013-4d80-4a35-8a06-ca108250473f', '/data/product/product-24.png', '9623e013-4d1c-4b34-af6e-2034e19457fc'),
	('9623e013-4d84-4110-8649-01cbe945d530', '/data/product/product-22.png', '9623e013-4d1c-4b34-af6e-2034e19457fc');
...
INSERT INTO `sc_shop_product_promotion` (`product_id`, `price_promotion`, `date_start`, `date_end`, `status_promotion`, `created_at`, `updated_at`) VALUES
	('9623e013-4cb3-4053-bd6e-112b97848d79', 50.00, NULL, NULL, 1, NULL, NULL),
	('9623e013-4cbc-4480-960f-89529f34af76', 30.00, NULL, NULL, 1, NULL, NULL),
	('9623e013-4cce-405b-b62f-b2e543e1f9c9', 50.00, NULL, NULL, 1, NULL, NULL),
	('9623e013-4cd7-49b8-9b7f-00763680b4e9', 40.00, NULL, NULL, 1, NULL, NULL),
	('9623e013-4ce8-4e40-804b-ad17f5105b81', 50.00, NULL, NULL, 1, NULL, NULL),
	('9623e013-4cfa-4c86-833b-893e6c6a14b4', 30.00, NULL, NULL, 1, NULL, NULL),
	('9623e013-4d02-4eab-8d9e-95c33c91d17e', 60.00, NULL, NULL, 1, NULL, NULL),
	('9623e013-4d13-46de-a0a6-f83c7440ba7e', 50.00, NULL, NULL, 1, NULL, NULL);
...
INSERT INTO `sc_shop_product_store` (`product_id`, `store_id`) VALUES
	('9623e013-4cb3-4053-bd6e-112b97848d79', '1'),
	('9623e013-4cbc-4480-960f-89529f34af76', '1'),
	('9623e013-4cc1-4326-b167-e2c5d8814c6f', '1'),
	('9623e013-4cc6-4714-b3b5-8a748d1c3bda', '1'),
	('9623e013-4cca-46e4-b74a-c58c85eda9e7', '1'),
	('9623e013-4cce-405b-b62f-b2e543e1f9c9', '1'),
	('9623e013-4cd3-45a4-a2b2-103aa1e81030', '1'),
	('9623e013-4cd7-49b8-9b7f-00763680b4e9', '1'),
	('9623e013-4cdc-44f3-8296-0b1163bf3786', '1'),
	('9623e013-4ce0-4f1c-8fe7-c27c1fc561a6', '1'),
	('9623e013-4ce4-440f-97b4-d4a12cc86d58', '1'),
	('9623e013-4ce8-4e40-804b-ad17f5105b81', '1'),
	('9623e013-4ced-4680-82f9-ce3302219061', '1'),
	('9623e013-4cf1-4dfb-8ad5-6fd63e77dd00', '1'),
	('9623e013-4cf5-4bf9-bd31-bb4ad55732bb', '1'),
	('9623e013-4cfa-4c86-833b-893e6c6a14b4', '1'),
	('9623e013-4cfe-40e9-bfa5-ad743ac9bccb', '1'),
	('9623e013-4d02-4eab-8d9e-95c33c91d17e', '1'),
	('9623e013-4d06-4b95-9fa6-6d2321c28610', '1'),
	('9623e013-4d0b-4fe9-8569-2ca6d2e8ab1d', '1'),
	('9623e013-4d0f-4b34-bb10-309824e9c8fd', '1'),
	('9623e013-4d13-46de-a0a6-f83c7440ba7e', '1'),
	('9623e013-4d18-4453-9a09-b78715c437b6', '1'),
	('9623e013-4d1c-4b34-af6e-2034e19457fc', '1');
...
INSERT INTO `sc_shop_store_block` (`id`, `name`, `position`, `page`, `type`, `text`, `status`, `sort`, `store_id`, `template`, `created_at`, `updated_at`) VALUES
	('9623e012-479d-423e-80fd-3cee0b2d9e64', 'Product special', 'left', '*', 'view', 'product_special_left', 1, 20, '1', 's-cart-light', NULL, NULL),
	('9623e012-47a3-4e37-9777-ef4fc73f91f3', 'Brands', 'left', '*', 'view', 'brand_left', 1, 30, '1', 's-cart-light', NULL, NULL),
	('9623e012-47a7-4092-ba4c-ee5670814ccc', 'Banner home', 'banner_top', 'home', 'view', 'banner_image', 1, 10, '1', 's-cart-light', NULL, NULL),
	('9623e012-47ac-4eb6-bb09-2d4d25089dea', 'Category', 'left', 'home,shop_home', 'view', 'category_left', 1, 20, '1', 's-cart-light', NULL, NULL),
	('9623e012-47b1-40f8-87a9-f37abe48cd6b', 'Product last view', 'left', '*', 'view', 'product_lastview_left', 1, 30, '1', 's-cart-light', NULL, NULL),
	('9623e012-47b5-40ec-bc47-375df09be58b', 'Products new', 'top', 'home', 'view', 'product_new', 1, 10, '1', 's-cart-light', NULL, NULL),
	('9623e012-47b9-4fe7-a535-b1bb71875bbe', 'Category store', 'left', 'shop_home,vendor_home,vendor_product_list', 'view', 'category_store_left', 1, 10, '1', 's-cart-light', NULL, NULL),
	('9623e012-47bd-4929-8dc8-55763a18b943', 'Top news', 'top', 'home', 'view', 'top_news', 1, 10, '1', 's-cart-light', NULL, NULL);
...
INSERT INTO `sc_shop_supplier` (`id`, `name`, `alias`, `email`, `phone`, `image`, `address`, `url`, `status`, `store_id`, `sort`, `created_at`, `updated_at`) VALUES
	('9623e013-45c6-47ce-908c-45b359e979d0', 'Supplier ABC', 'supplier-abc', 'abc@gmail.com', '0123456789', '/data/supplier/supplier.jpg', NULL, NULL, 1, '1', 0, NULL, NULL),
	('9623e013-45cf-4291-9c22-9616ef5853cb', 'Supplier XYZ', 'supplier-xyz', 'xyz@gmail.com', '0987654321', '/data/supplier/supplier.jpg', NULL, NULL, 1, '1', 0, NULL, NULL);
