...
('global', 'env_global', 'ADMIN_LOG', 'on', '0', 'env.ADMIN_LOG', 0),
('global', 'env_global', 'ADMIN_LOG_EXP', '', '0', 'env.ADMIN_LOG_EXP', 0),
('global', 'env_global', 'ADMIN_FOOTER_OFF', '0', '0', 'env.ADMIN_FOOTER_OFF', 0),
('global', 'seo_config', 'url_seo_lang', '0', '1', 'seo.url_seo_lang', 0),
('global', 'webhook_config', 'LOG_SLACK_WEBHOOK_URL', '', '0', 'config.LOG_SLACK_WEBHOOK_URL', 0),
('global', 'webhook_config', 'GOOGLE_CHAT_WEBHOOK_URL', '', '0', 'config.GOOGLE_CHAT_WEBHOOK_URL', 0),
('global', 'webhook_config', 'CHATWORK_CHAT_WEBHOOK_URL', '', '0', 'config.CHATWORK_CHAT_WEBHOOK_URL', 0),
('global', 'api_config', 'api_connection_required', '1', '1', 'api_connection.api_connection_required', 0),
('global', 'cache', 'cache_status', '0', '0', 'cache.config_manager.cache_status', 0),
('global', 'cache', 'cache_time', '600', '0', 'cache.config_manager.cache_time', 0),
('global', 'cache', 'cache_category', '0', '3', 'cache.config_manager.cache_category', 0),
('global', 'cache', 'cache_product', '0', '4', 'cache.config_manager.cache_product', 0),
('global', 'cache', 'cache_news', '0', '5', 'cache.config_manager.cache_news', 0),
('global', 'cache', 'cache_category_cms', '0', '6', 'cache.config_manager.cache_category_cms', 0),
('global', 'cache', 'cache_content_cms', '0', '7', 'cache.config_manager.cache_content_cms', 0),
('global', 'cache', 'cache_page', '0', '8', 'cache.config_manager.cache_page', 0),
('global', 'cache', 'cache_country', '0', '10', 'cache.config_manager.cache_country', 0),
