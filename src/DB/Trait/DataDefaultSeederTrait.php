...
trait DataDefaultSeederTrait
{
    ...
    public function dataMenu() {
        $dataMenu = [
            ...
            ['id' => 55,'parent_id' => 67,'sort' => 0,'title' => 'admin.menu_titles.modify_layout','icon' => 'fa fa-columns','uri' => 'admin::store_modify_layout','key' => null,'type' => 0],
    ...
    public function dataAdminPermission($prefix) {
        $dataAdminPermission = [
            ...
            ['id' => '4','name' => 'Store manager','slug' => 'store.full','http_uri' => 'ANY::'.$prefix.'/store_info/*,ANY::'.$prefix.'/store_maintain/*,ANY::'.$prefix.'/store_config/*,ANY::'.$prefix.'/store_css/*,ANY::'.$prefix.'/store_block/*,ANY::'.$prefix.'/store_link/*,ANY::'.$prefix.'/store_modify_layout/*'],
    ...
    public function dataAdminConfig() {
        $dataAdminConfig = [
            ['id' => (string)Str::orderedUuid(),'group' => 'Plugins','code' => 'Payment','key' => 'Cash','value' => '1','sort' => '0','detail' => 'Plugins/Payment/Cash::lang.title','store_id' => 0],
            ['id' => (string)Str::orderedUuid(),'group' => 'Plugins','code' => 'Shipping','key' => 'ShippingStandard','value' => '1','sort' => '0','detail' => 'Shipping Standard','store_id' => 0],
            ['id' => (string)Str::orderedUuid(),'group' => 'global','code' => 'seo_config','key' => 'url_seo_lang','value' => '0','sort' => '1','detail' => 'seo.url_seo_lang','store_id' => 0],
            ['id' => (string)Str::orderedUuid(),'group' => 'global','code' => 'webhook_config','key' => 'LOG_SLACK_WEBHOOK_URL','value' => '','sort' => '0','detail' => 'admin.config.LOG_SLACK_WEBHOOK_URL','store_id' => 0],
            ['id' => (string)Str::orderedUuid(),'group' => 'global','code' => 'webhook_config','key' => 'GOOGLE_CHAT_WEBHOOK_URL','value' => '','sort' => '0','detail' => 'admin.config.GOOGLE_CHAT_WEBHOOK_URL','store_id' => 0],
            ['id' => (string)Str::orderedUuid(),'group' => 'global','code' => 'webhook_config','key' => 'CHATWORK_CHAT_WEBHOOK_URL','value' => '','sort' => '0','detail' => 'admin.config.CHATWORK_CHAT_WEBHOOK_URL','store_id' => 0],
            ['id' => (string)Str::orderedUuid(),'group' => 'global','code' => 'api_config','key' => 'api_connection_required','value' => '1','sort' => '1','detail' => 'api_connection.api_connection_required','store_id' => 0],
            ['id' => (string)Str::orderedUuid(),'group' => 'global','code' => 'api_config','key' => 'api_mode','value' => '0','sort' => '1','detail' => 'api_connection.api_mode','store_id' => 0],
            ['id' => (string)Str::orderedUuid(),'group' => 'global','code' => 'cache','key' => 'cache_status','value' => '0','sort' => '0','detail' => 'admin.cache.cache_status','store_id' => 0],
            ['id' => (string)Str::orderedUuid(),'group' => 'global','code' => 'cache','key' => 'cache_time','value' => '600','sort' => '0','detail' => 'admin.cache.cache_time','store_id' => 0],
            ['id' => (string)Str::orderedUuid(),'group' => 'global','code' => 'cache','key' => 'cache_category','value' => '0','sort' => '3','detail' => 'admin.cache.cache_category','store_id' => 0],
            ['id' => (string)Str::orderedUuid(),'group' => 'global','code' => 'cache','key' => 'cache_product','value' => '0','sort' => '4','detail' => 'admin.cache.cache_product','store_id' => 0],
            ['id' => (string)Str::orderedUuid(),'group' => 'global','code' => 'cache','key' => 'cache_news','value' => '0','sort' => '5','detail' => 'admin.cache.cache_news','store_id' => 0],
            ['id' => (string)Str::orderedUuid(),'group' => 'global','code' => 'cache','key' => 'cache_category_cms','value' => '0','sort' => '6','detail' => 'admin.cache.cache_category_cms','store_id' => 0],
            ['id' => (string)Str::orderedUuid(),'group' => 'global','code' => 'cache','key' => 'cache_content_cms','value' => '0','sort' => '7','detail' => 'admin.cache.cache_content_cms','store_id' => 0],
            ['id' => (string)Str::orderedUuid(),'group' => 'global','code' => 'cache','key' => 'cache_page','value' => '0','sort' => '8','detail' => 'admin.cache.cache_page','store_id' => 0],
            ['id' => (string)Str::orderedUuid(),'group' => 'global','code' => 'cache','key' => 'cache_country','value' => '0','sort' => '10','detail' => 'admin.cache.cache_country','store_id' => 0],
            ['id' => (string)Str::orderedUuid(),'group' => 'global','code' => 'env_mail','key' => 'smtp_mode','value' => '','sort' => '0','detail' => 'email.smtp_mode','store_id' => 0],
        ];
