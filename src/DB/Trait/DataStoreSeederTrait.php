...
trait DataStoreSeederTrait
{
    ...
    public function dataEmailTemplate($storeId) {
        $dataEmailTemplate = [
            ['id' => 1,'name' => 'Reset password','group' => 'forgot_password','text' => '
...
<tbody>
    ...
    <tr>
        <td style="font-family:Avenir,Helvetica,sans-serif;box-sizing:border-box">
            ...
            ['id' => 2,'name' => 'Customer verification','group' => 'customer_verify','text' => '
<h1 style="font-family:Avenir,Helvetica,sans-serif;box-sizing:border-box;color:#2f3133;font-size:19px;font-weight:bold;margin-top:0;text-align:left">{{$title}}</h1>
<p style="font-family:Avenir,Helvetica,sans-serif;box-sizing:border-box;color:#74787e;font-size:16px;line-height:1.5em;margin-top:0;text-align:left">{{$reason_sendmail}}</p>
<table class="action" align="center" width="100%" cellpadding="0" cellspacing="0" style="font-family:Avenir,Helvetica,sans-serif;box-sizing:border-box;margin:30px auto;padding:0;text-align:center;width:100%">
    <tbody>
    ...
    <tr>
        <td style="font-family:Avenir,Helvetica,sans-serif;box-sizing:border-box">
            ...
            ['id' => 3,'name' => 'Welcome new customer','group' => 'welcome_customer','text' => '
...
<p style="text-align:center;">Welcome to my site!</p>','status' => '1','store_id' => $storeId],
            ['id' => 4,'name' => 'Send form contact to admin','group' => 'contact_to_admin','text' => '
...
<tr>
   <td>{{$content}}</td>
            ...
            ['id' => 5,'name' => 'New order to admin','group' => 'order_success_to_admin','text' => '
<table class="inner-body" align="center" cellpadding="0" cellspacing="0">
<tr>
   <td>
...
<tr>
   ...
   <td colspan="2" align="right">{{$total}}</td>
            ...
            ['id' => 6,'name' => 'New order to customr','group' => 'order_success_to_customer','text' => '
<table class="inner-body" align="center" cellpadding="0" cellspacing="0">
<tr>
   <td>
      <b>Order ID</b>: {{$orderID}}<br>
...
<tr>
   ...
   <td colspan="2" align="right">{{$total}}</td>
    ...
    public function dataStoreBlock($storeId) {
        $dataStoreBlock = [
            ['id' => 1,'name' => 'Product special','position' => 'left','page' => '*','type' => 'view','text' => 'product_special_left','status' => '1','sort' => '20','store_id' => $storeId,'template' => 's-cart-light'],
            ['id' => 2,'name' => 'Brands','position' => 'left','page' => '*','type' => 'view','text' => 'brand_left','status' => '1','sort' => '30','store_id' => $storeId,'template' => 's-cart-light'],
            ['id' => 3,'name' => 'Banner home','position' => 'banner_top','page' => 'home','type' => 'view','text' => 'banner_image','status' => '1','sort' => '10','store_id' => $storeId,'template' => 's-cart-light'],
            ['id' => 4,'name' => 'Category','position' => 'left','page' => 'home,shop_home','type' => 'view','text' => 'category_left','status' => '1','sort' => '20','store_id' => $storeId,'template' => 's-cart-light'],
            ['id' => 5,'name' => 'Product last view','position' => 'left','page' => '*','type' => 'view','text' => 'product_lastview_left','status' => '1','sort' => '30','store_id' => $storeId,'template' => 's-cart-light'],
            ['id' => 6,'name' => 'Products new','position' => 'top','page' => 'home','type' => 'view','text' => 'product_new','status' => '1','sort' => '10','store_id' => $storeId,'template' => 's-cart-light'],
            ['id' => 7,'name' => 'Category store','position' => 'left','page' => 'shop_home,vendor_home,vendor_product_list','type' => 'view','text' => 'category_store_left','status' => '1','sort' => '10','store_id' => $storeId,'template' => 's-cart-light'],
            ['id' => 8,'name' => 'Top news','position' => 'top','page' => 'home','type' => 'view','text' => 'top_news','status' => '1','sort' => '10','store_id' => $storeId,'template' => 's-cart-light'],
        ];
