...
@if (sc_config_admin('product_weight'))
                        ...
                        <div class="form-group row {{ $errors->has('weight_class') ? ' text-red' : '' }}">
                            <label for="weight_class" class="col-sm-2 col-form-label">{{ sc_language_render('product.weight_class') }} (<a href="{{ sc_route_admin('admin_weight_unit.index') }}"><i class="fa fa-link" aria-hidden="true"></i></a>)</label>
                            <div class="col-sm-8">
...
@if (sc_config_admin('product_length'))
                        ...
                        <div class="form-group row {{ $errors->has('length_class') ? ' text-red' : '' }}">
                            <label for="length_class" class="col-sm-2 col-form-label">{{ sc_language_render('product.length_class') }} (<a href="{{ sc_route_admin('admin_length_unit.index') }}"><i class="fa fa-link" aria-hidden="true"></i></a>)</label>
                            <div class="col-sm-8">
