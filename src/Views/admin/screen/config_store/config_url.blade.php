   ...
   <table class="table table-hover box-body text-wrap table-bordered">
     <tbody>
      ...
      <tr>
        ...
        <td>https://your-domain.com/<a href="#" class="editable-required editable editable-click" data-name="PREFIX_SHOP" data-type="text" data-pk="" data-source="" data-url="{{ $urlUpdateConfig }}" data-title="{{ sc_language_render('admin.env.PREFIX_SHOP') }}" data-value="{{ sc_config('PREFIX_SHOP', $storeId) }}" data-original-title="" title=""></a></td>
      </tr>
