    ...
    public function index()
    {
        ...
        foreach ($dataTmp as $key => $row) {
            $dataTr[] = [
                ...
                'action' => '
                    <a href="' . sc_route_admin('admin_email_template.edit', ['id' => $row['id']]) . '"><span title="' . sc_language_render('action.admin.edit') . '" type="button" class="btn btn-flat btn-sm btn-primary"><i class="fa fa-edit"></i></span></a>&nbsp;
