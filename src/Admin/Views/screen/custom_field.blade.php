    ...
    <div class="card">
      <div class="card-header">
        ...
        <div class="btn-group float-right" style="margin-right: 5px">
            <a href="{{ sc_route_admin('admin_custom_field.index') }}" class="btn  btn-flat btn-default" title="List"><i class="fa fa-list"></i><span class="hidden-xs"> {{trans('admin.back_list')}}</span></a>
        </div>
      @endif
      </div>
      <!-- /.card-header -->
      ...
      <form action="{{ $url_action }}" method="post" accept-charset="UTF-8" class="form-horizontal" id="form-main">
        <div class="card-body">
          ...
          <div class="form-group row {{ $errors->has('name') ? ' text-red' : '' }}">
            <label for="name" class="col-sm-2 col-form-label">{{ trans('custom_field.name') }}</label>
            <div class="col-sm-10 ">
          ...
          <div class="form-group row {{ $errors->has('code') ? ' text-red' : '' }}">
            <label for="code" class="col-sm-2 col-form-label">{!! trans('custom_field.code') !!}</label>
            <div class="col-sm-10 ">
              <div class="input-group mb-3">
                <div class="input-group-prepend">
                  <span class="input-group-text"><i class="fas fa-pencil-alt"></i></span>
          ...
          <div class="form-group row {{ $errors->has('type') ? ' text-red' : '' }}">
            <label for="type" class="col-sm-2 col-form-label">{!! trans('custom_field.type') !!}</label>
            <div class="col-sm-10 ">
              <div class="input-group mb-3">
          ...
          <div class="form-group row {{ $errors->has('option') ? ' text-red' : '' }}">
            <label for="option" class="col-sm-2 col-form-label">{!! trans('custom_field.option') !!}</label>
            <div class="col-sm-10 ">
              <div class="input-group mb-3">
          ...
          <div class="form-group row {{ $errors->has('default') ? ' text-red' : '' }}">
            <label for="default" class="col-sm-2 col-form-label">{!! trans('custom_field.default') !!}</label>
            <div class="col-sm-10 ">
              <div class="input-group mb-3">
                <div class="input-group-prepend">
                  <span class="input-group-text"><i class="fas fa-pencil-alt"></i></span>
          ...
          <div class="form-group row {{ $errors->has('required') ? ' text-red' : '' }}">
            <label for="required" class="col-sm-2 col-form-label">{!! trans('custom_field.required') !!}</label>
            <div class="col-sm-10 ">
              <div class="input-group mb-3">
          ...
          <div class="form-group row {{ $errors->has('status') ? ' text-red' : '' }}">
            <label for="status" class="col-sm-2 col-form-label">{!! trans('custom_field.status') !!}</label>
            <div class="col-sm-10 ">
              <div class="input-group mb-3">
