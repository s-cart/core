            ...
            <div class="card-header with-border">
                ...
                <div class="card-tools">
                    <div class="btn-group float-right mr-5">
                        <a href="{{ sc_route('admin_page.index') }}" class="btn  btn-flat btn-default" title="List"><i
...
<script type="text/javascript">
    ...
    {
        filebrowserImageBrowseUrl: '{{ sc_route('admin.home').'/'.config('lfm.url_prefix') }}?type=page',
        filebrowserImageUploadUrl: '{{ sc_route('admin.home').'/'.config('lfm.url_prefix') }}/upload?type=page&_token={{csrf_token()}}',
