   ...
   <table class="table table-hover box-body text-wrap table-bordered">
     <tbody>
      ...
      <tr>
        ...
        <td><a href="#" class="updateInfo editable editable-click" data-name="SUFFIX_URL" data-type="text" data-pk="" data-source="" data-url="{{ sc_route('admin_config.update') }}" data-title="{{ trans('env.SUFFIX_URL') }}" data-value="{{ sc_config('SUFFIX_URL', $storeId) }}" data-original-title="" title=""></a></td>
      </tr>

      <tr>
        <td>{{ trans('env.PREFIX_SHOP') }}</td>
        <td>https://your-domain.com/<a href="#" class="editable-required editable editable-click" data-name="PREFIX_SHOP" data-type="text" data-pk="" data-source="" data-url="{{ sc_route('admin_config.update') }}" data-title="{{ trans('env.PREFIX_SHOP') }}" data-value="{{ sc_config('PREFIX_SHOP', $storeId) }}" data-original-title="" title=""></a></td>
      </tr>
      ...
      <tr>
        ...
        <td>https://your-domain.com/<a href="#" class="editable-required editable editable-click" data-name="PREFIX_SUB_CATEGORY" data-type="text" data-pk="" data-source="" data-url="{{ sc_route('admin_config.update') }}" data-title="{{ trans('env.PREFIX_SUB_CATEGORY') }}" data-value="{{ sc_config('PREFIX_SUB_CATEGORY', $storeId) }}" data-original-title="" title=""></a>/name-of-category{{ sc_config('SUFFIX_URL', $storeId) }}</td>
      </tr>
