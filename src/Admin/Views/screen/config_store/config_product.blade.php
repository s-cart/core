       ...
       <table class="table table-hover box-body text-wrap table-bordered">
         <tbody>
           ...
           <tr>
            ...
            <td><a href="#" class="editable-required" data-name="product_tax" data-type="select" data-pk="" data-source="{{ json_encode($taxs) }}" data-url="{{ sc_route('admin_config.update') }}" data-title="{{ trans('product.config_manager.tax') }}" data-value="{{ sc_config_admin('product_tax') }}" data-original-title="" title="" data-placement="left"></a></td>
          </tr>
           @else
           <tr>
