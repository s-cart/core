...
<div class="row">
    <div class="col-md-12">
        <div class="card">
            ...
            <form action="{{ sc_route('admin_template.process_import') }}" method="post" accept-charset="UTF-8" class="form-horizontal" id="import-product" enctype="multipart/form-data">
                @csrf
                <div class="box-body">
