       ...
       <table class="table table-hover box-body text-wrap table-bordered">
         <tbody>
          ...
          <tr>
            ...
            <td>
              <a href="#" class="fied-required editable editable-click" data-name="cache_status" data-type="select" data-pk="" data-source="{{ json_encode(['1'=>'ON','0'=>'OFF']) }}" data-url="{{ sc_route_admin('admin_config_global.update') }}" data-title="{{ trans('cache.config_manager.cache_status') }}" data-value="{{ sc_config_admin('cache_status') }}" data-original-title="" title=""></a>
            </td>
            <td></td>
          </tr>
          <tr>
            ...
            <td>
              <a href="#" class="cache-time data-cache_time"  data-name="cache_time" data-type="text" data-pk="" data-url="{{ sc_route_admin('admin_config_global.update') }}" data-title="{{ trans('cache.config_manager.cache_time') }}">{{ sc_config_admin('cache_time') }}</a>
            </td>
            <td></td>
          </tr>
